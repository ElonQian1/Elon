...
internal class ChatGptWebNativeVoiceResearchMcpPort(
    ...
    private fun stateJson(): JSONObject {
        ...
        return JSONObject()
            ...
            .put("transcript_delta_rejected_count", observed.transcriptDeltaDiagnostics.rejectedCount)
            .put("transcript_delta_highest_channel", observed.transcriptDeltaDiagnostics.highestChannel ?: JSONObject.NULL)
            .put("transcript_delta_cached_channels", observed.transcriptDeltaDiagnostics.cachedChannels)
            .put("transcript_delta_last_rejection", observed.transcriptDeltaDiagnostics.lastRejection ?: JSONObject.NULL)
