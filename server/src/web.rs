...
const PC_APP_CLIENT_MAINTENANCE_JS: &str = include_str!("assets/pc_app_client_maintenance.js");
...
pub async fn pc_app_client_maintenance_js() -> impl IntoResponse {
    (
        [
            (
                header::CONTENT_TYPE,
