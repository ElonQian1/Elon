...
fn event_type(tool: &str) -> Option<&'static str> {
    Some(match tool {
        ...
        "ui_check_design_source_binding" => "SOURCE_BINDING_CHECKED",
        "ui_plan_design_intent" => "DESIGN_INTENT_PLANNED",
        "ui_start_design_intent_plan" => "DESIGN_INTENT_STARTED",
        "ui_transition_design_intent_plan" => "DESIGN_INTENT_TRANSITIONED",
        "ui_record_design_intent_action" => "DESIGN_INTENT_ACTION_RECORDED",
        "ui_replan_design_intent" => "DESIGN_INTENT_REPLANNED",
        "ui_plan_design_writeback" => "WRITEBACK_PLANNED",
