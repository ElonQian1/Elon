...
| AI 任务与开放商业链外影子结算 / 双分录 / Sui 链下投影包 | `docs/decisions/task-shadow-settlement-v1.md`、`docs/decisions/sui-offchain-projection-packages-v1.md`、`docs/task-shadow-settlement-v1-api.md`、`server/src/task_settlement/`、`server/src/store/task_sui_projection_packages.rs` |
