...
internal fun createBinanceHostWebView(context: Context, runtime: BinanceHostRuntime): WebView {
    ...
    return WebView(context).apply {
        ...
        WebViewCompat.addDocumentStartJavaScript(this,
            listOf("binance_grid_read_diagnostics.js", "binance_grid_reports_adapter.js", "binance_grid_read_adapter.js", "binance_grid_range_contract.js", "binance_grid_create_adapter.js").joinToString("\n") { asset ->
