...
| external-pool V274 activation-rooted active successor / exact serde_json projected-active Provider / 2 immutable tables + 1 diagnostic view / Store-private、V275前零行 | `docs/distributed-compute/external-pool-adapter-provider-active-successor-authority.md`、`docs/distributed-compute/external-pool-adapter-provider-active-successor-acceptance.md` |
| external-pool V275 stable executor + atomic activation docs freeze / 1 immutable receipt table、0 view、0 revocation / V274→V275 immediate witness / 16 INSERT + 1 CAS UPDATE / 9 pending permits + 9 absolute denies / eligible_rows=0 | `docs/distributed-compute/external-pool-adapter-stable-executor-atomic-activation-authority.md`、`docs/distributed-compute/external-pool-adapter-stable-executor-atomic-activation-acceptance.md` |
