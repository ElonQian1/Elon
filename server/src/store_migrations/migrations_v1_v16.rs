...
// ── v1：初始表结构 ────────────────────────────────────────────────────────────
pub(crate) fn migration_v1(conn: &Connection) -> Result<()> {
    conn.execute_batch(
        r#"
...
pub(crate) fn migration_v2(conn: &Connection) -> Result<()> {
...
pub(crate) fn migration_v3(conn: &Connection) -> Result<()> {
    conn.execute(
...
pub(crate) fn migration_v4(conn: &Connection) -> Result<()> {
    conn.execute_batch(
        r#"
        CREATE TABLE IF NOT EXISTS friend_read_states (
          user_id TEXT NOT NULL,
...
pub(crate) fn migration_v5(conn: &Connection) -> Result<()> {
...
pub(crate) fn migration_v6(conn: &Connection) -> Result<()> {
    conn.execute_batch(
        r#"
...
pub(crate) fn migration_v7(conn: &Connection) -> Result<()> {
    conn.execute_batch(
        r#"
...
pub(crate) fn migration_v8(conn: &Connection) -> Result<()> {
    add_column_if_missing(
        conn,
        "friend_messages",
        "attachments_json",
...
pub(crate) fn migration_v9(conn: &Connection) -> Result<()> {
    conn.execute_batch(
        r#"
        UPDATE projects
           SET status = 'deleted'
...
pub(crate) fn migration_v10(conn: &Connection) -> Result<()> {
...
pub(crate) fn migration_v11(conn: &Connection) -> Result<()> {
    add_column_if_missing(
        conn,
        "projects",
        "last_build_sha",
...
pub(crate) fn migration_v12(conn: &Connection) -> Result<()> {
    add_column_if_missing(
        conn,
        "friend_messages",
        "context_user_id",
...
pub(crate) fn migration_v13(conn: &Connection) -> Result<()> {
    conn.execute_batch(
        r#"
...
pub(crate) fn migration_v14(conn: &Connection) -> Result<()> {
    add_column_if_missing(
        conn,
...
pub(crate) fn migration_v15(conn: &Connection) -> Result<()> {
    conn.execute_batch(
        r#"
...
pub(crate) fn migration_v16(conn: &Connection) -> Result<()> {
    conn.execute_batch(
        r#"
        -- token 用量事件（按调用记录）
