...
pub(crate) struct NodeRuntime {
    ...
    pub(crate) browser_research: crate::node_agent_browser_research::BrowserResearchHub,
...
impl NodeRuntime {
    pub(crate) fn new(
        ...
        Self {
            ...
            ui_fit_runs,
            win_codex_control,
            browser_research: crate::node_agent_browser_research::BrowserResearchHub::default(),
            wake: Notify::new(),
            desktop_review_auth,
    ...
    pub(crate) async fn finish_cli_prompt(self: &Arc<Self>, req_id: &str) {
