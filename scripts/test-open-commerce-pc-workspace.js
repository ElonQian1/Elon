...
assert.ok(portabilityUi.includes('本人低敏偏好和披露快照'), 'PC must explain the V2 owner preference export')
assert.ok(portabilityUi.includes('不含订单、联系方式、支付或账号标识'), 'PC must state the remaining V2 portability boundary')
...
assert.ok(portabilityModel.includes('CONSUMER_PORTABILITY_EXPORT_SCHEMA_V1'), 'V2 must retain an explicit V1 compatibility contract')
