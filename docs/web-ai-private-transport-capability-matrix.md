...
| Independent native file library | ChatGPT | Published/installed 1.1.1581; native root/folder/cache/search reads verified; rendered UI, pagination and binary downloads pending; [evidence](chatgpt-private-library-browser.md) | Retained rows on refresh failure; explicit official library, no automatic navigation |
