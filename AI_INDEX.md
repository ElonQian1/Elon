...
| 任务级分布式算力联邦 / Provider、Offer、Job、Reservation、Attempt、验证回执与 CNY 账本 / external-pool V249-V269 roots、Profile V2 signed compatibility、admin signing handoff、post-exec supervisor、Secret delivery 与 Broker TLS | `docs/distributed-compute/README.md`、`docs/distributed-compute/current-implementation-status.md`、`docs/distributed-compute/external-pool-adapter-runtime-compatibility-signing-handoff-authority.md`、`docs/distributed-compute/external-pool-adapter-runtime-compatibility-signing-handoff-acceptance.md`、`docs/distributed-compute/external-pool-adapter-signed-runtime-compatibility-authority.md`、`docs/distributed-compute/external-pool-adapter-signed-runtime-compatibility-acceptance.md`、`docs/distributed-compute/external-pool-adapter-post-exec-supervisor-hardening-authority.md`、`docs/distributed-compute/external-pool-adapter-post-exec-supervisor-hardening-acceptance.md`、`docs/distributed-compute/external-pool-adapter-broker-tls-transport-authority.md`、`docs/distributed-compute/external-pool-adapter-broker-tls-transport-acceptance.md`、`docs/distributed-compute/external-pool-adapter-ephemeral-secret-delivery-authority.md`、`docs/distributed-compute/external-pool-adapter-supervisor-session-policy-companion-authority.md`、`docs/distributed-compute/external-pool-adapter-upstream-transport-target-authority.md`、`docs/distributed-compute/external-pool-adapter-entrypoint-capsule-authority.md`、`docs/distributed-compute/external-pool-adapter-runtime-bundle-resolver-authority.md`、`docs/distributed-compute/external-pool-adapter-runtime-launch-profile-authority.md`、`docs/distributed-compute/external-pool-provider-activation-candidate-authority.md`、`docs/distributed-compute/external-pool-adapter-credential-reattestation-authority.md`、`docs/distributed-compute/external-pool-adapter-sandbox-reattestation-authority.md`、`docs/distributed-compute/external-pool-adapter-vulnerability-reattestation-authority.md`、`docs/distributed-compute/external-pool-adapter-registry-authority.md`、`docs/distributed-compute/external-pool-adapter-installation-authority.md`、`docs/distributed-compute/market-and-settlement.md`、`server/src/compute_federation/external_pool_adapter_runtime_compatibility_verification.rs`、`server/src/compute_federation/external_pool_adapter_runtime_compatibility_verification_api.rs`、`server/src/compute_federation/external_pool_adapter_runtime_compatibility_signing_handoff_service.rs`、`server/src/compute_federation/external_pool_adapter_runtime_compatibility_signing_handoff_runtime.rs`、`server/src/store/compute_external_pool_adapter_runtime_compatibility_verification/handoff.rs`、`server/src/compute_federation/external_pool_adapter_entrypoint_capsule/launch_image.rs`、`server/src/compute_federation/external_pool_adapter_linux_supervisor/`、`server/src/compute_federation/external_pool_adapter_broker_tls/` |
