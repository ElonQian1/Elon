...
impl PinnedManagedSqliteNamespace {
    ...
    pub(crate) fn into_wal_runtime(
        ...
        let coordinator = Arc::new(ManagedSqliteShmCoordinator {
            ...
            #[cfg(all(test, windows))]
            test_initialization_runtime: Mutex::new(
                super::test_initialization_runtime::ManagedSqliteShmTestInitializationControllerV1::default(),
            ),
            #[cfg(all(test, windows))]
            test_map_runtime: Mutex::new(
                super::test_map_runtime::ManagedSqliteShmTestMapController::default(),
            ),
            #[cfg(all(test, windows))]
