...
| Provider / Offer / Job / Reservation / Lease / Receipt 统一领域合同 | 基础代码、v169-v176 注册表、Broker Reserve/未执行任务终态、v185-v190 Attempt 激活、续租、中止、累计声明用量、Provider 终态候选与消费者审核证据已写，状态为 `implementation_uncompiled`，尚未迁移、完整接线和运行验证 |
