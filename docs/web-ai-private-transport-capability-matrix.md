...
| Independent native file library | ChatGPT | Root/folder/cache/search and pagination data verified; module 8 fixes observed estuary redirect, 78 saved bytes verified in diagnostic 1583; normal-package/rendered UI acceptance pending; [evidence](chatgpt-private-library-browser.md) | Retained rows on refresh failure; explicit official library, no automatic navigation |
