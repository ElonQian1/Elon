//! Type-preserving SQLite value fingerprints for one V277 pending write.

use rusqlite::types::{Value, ValueRef};

use super::ExternalPoolAdapterAtomicActivationPendingWriteKind;

#[derive(Eq, PartialEq)]
pub(super) struct PendingWriteFingerprint {
    pub(super) kind: ExternalPoolAdapterAtomicActivationPendingWriteKind,
