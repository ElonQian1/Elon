...
| Native existing-library attachment | ChatGPT | Native-menu association/ready receipt verified in 1584; missing composer card correction, metadata retention and explicit send still under acceptance; [evidence](chatgpt-private-library-attachment.md) | Preserve draft; no reupload, automatic send or cross-context association |
