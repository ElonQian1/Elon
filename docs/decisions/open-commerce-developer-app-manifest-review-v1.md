...
implementation_status: implementation_compiled_local_state_http_subset
---
...
4. 提交审核前必须完成当前资料修订的主页域名控制证明。平台管理员只能审核仍处于 `submitted` 的同一修订；要求修改必须填写审核说明，所有状态变化进入开放商业审计事件。
