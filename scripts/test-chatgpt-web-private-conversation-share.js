...
const { fixture, CID, NODE, NEXT, SID, PATH, LINK, MODERATION } = require('./fixtures/chatgpt-web-private-conversation-share.cjs');
...
test('share modules parse in the same concatenated asset scope and are registered', () => {
  ...
  assert.equal(f.page.__elonChatGptPrivateConversationShare.version, 3);
