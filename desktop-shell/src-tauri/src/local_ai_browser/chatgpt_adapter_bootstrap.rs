...
pub(super) const ADAPTER_VERSION: u32 = 214;
...
const ADAPTER_ASSETS: &[(&str, &str)] = &[
    ...
    (
        ...
        include_str!("../../../../android/app/src/main/assets/chatgpt_web_adapter_control_labels.js"),
    ),
    (
        "chatgpt_web_adapter_project_choice_reveal.js",
        include_str!("../../../../android/app/src/main/assets/chatgpt_web_adapter_project_choice_reveal.js"),
    ),
    (
    ...
    (
        ...
        include_str!("../../../../android/app/src/main/assets/chatgpt_web_adapter_composer_dismiss_policy.js"),
    ),
    (
        "chatgpt_web_dictation_runtime.js",
        include_str!("../../../../android/app/src/main/assets/chatgpt_web_dictation_runtime.js"),
    ),
    (
    ...
    (
        ...
        include_str!("../../../../android/app/src/main/assets/chatgpt_web_stream_watchdog_acceptance.js"),
    ),
    (
    ...
    (
        ...
        include_str!("../../../../android/app/src/main/assets/chatgpt_web_attachment_transport_observer.js"),
    ),
    (
...
mod tests {
    ...
    fn win_bootstrap_uses_reviewed_shared_adapter_modules() {
        ...
        assert!(script.contains("chatgpt_win_private_stream_binding.js"));
        assert!(script.contains("__elonWinChatGptPrivateStreamBindingLifecycle.commit(window)"));
        assert!(script.contains("__elonWinChatGptPrivateStreamRecovery"));
        assert!(
            script
                .find("chatgpt_win_private_stream_binding.js")
                .unwrap()
                < script
                    .find("chatgpt_web_private_stream_transport.js")
                    .unwrap()
