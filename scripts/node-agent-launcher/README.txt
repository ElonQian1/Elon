...
1. 解压本压缩包。
2. 双击「一龙开发平台.exe」。
3. 浏览器优先打开你熟悉的云端「一龙 PC 工作台」；云端不可达时自动打开本机兜底工作台。
...
- 优先打开云端 PC 工作台；网络异常时自动回退到本机同款工作台外壳和电脑连接状态
- 后续启动时自动更新客户端主程序
