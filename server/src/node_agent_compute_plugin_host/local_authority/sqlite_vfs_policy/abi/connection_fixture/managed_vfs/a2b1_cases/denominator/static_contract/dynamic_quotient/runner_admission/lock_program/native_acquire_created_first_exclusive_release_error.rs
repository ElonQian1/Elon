//! Exact q12 source programs for created-first DMS exclusive-release outcome uncertainty.
//!
...
pub(super) use source_scope::NATIVE_ACQUIRE_CREATED_FIRST_EXCLUSIVE_RELEASE_ERROR_PROJECTOR_DELTA_V1;
...
pub(super) const CREATED_FIRST_EXCLUSIVE_RELEASE_ERROR_MEMBER_COUNT: usize = 88;

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(super) enum LockCreatedFirstExclusiveReleaseCompletionV1 {
    RetentionSucceeded,
    RetentionRouteUnknown,
}

impl LockCreatedFirstExclusiveReleaseCompletionV1 {
...
#[derive(Clone, Copy)]
pub(super) struct LockNativeAcquireCreatedFirstExclusiveReleaseErrorProgramSpecV1 {
    #[cfg(windows)]
    ...
    pub(super) mask: u8,
    #[cfg(windows)]
    pub(super) completion: LockCreatedFirstExclusiveReleaseCompletionV1,
...
) -> Option<LockCreatedFirstExclusiveReleaseCompletionV1> {
    match value {
        ReachabilityV1::Reached(LockCompletionV1::UnsafeRetentionSucceededThenRouteUnknown) => {
            Some(LockCreatedFirstExclusiveReleaseCompletionV1::RetentionSucceeded)
        }
        ReachabilityV1::Reached(
            LockCompletionV1::UnsafeRetentionRouteUnknownThenRouteUnknown,
        ) => Some(LockCreatedFirstExclusiveReleaseCompletionV1::RetentionRouteUnknown),
        _ => None,
    }
}
