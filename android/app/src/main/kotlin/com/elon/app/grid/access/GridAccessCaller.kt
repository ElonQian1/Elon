...
internal fun Activity.hasOfficialGridAccessCaller(): Boolean = runCatching {
    ...
    activity.enabled && activity.applicationInfo.enabled && activity.targetActivity == null &&
        ...
        packageManager.getComponentEnabledSetting(caller) in allowed && packageManager.getApplicationEnabledSetting(caller.packageName) in allowed &&
        OfficialQuantApkPolicy.accepts(installed.packageName, currentPackageSignerSha256(installed), installed.projectApkVersionCode())
}.getOrDefault(false)
