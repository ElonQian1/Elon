...
internal fun createWebChatRealtimeVoiceCoordinator(
    ...
    startManagedWebRtc: () -> Boolean,
    managedWebRtcState: () -> WebChatManagedRealtimeVoiceState,
    setManagedWebRtcMuted: (Boolean) -> Boolean,
    ...
    coordinator = WebChatRealtimeVoiceCoordinator(
        ...
        startManagedWebRtc = startManagedWebRtc,
        managedWebRtcState = managedWebRtcState,
        setManagedWebRtcMuted = setManagedWebRtcMuted,
