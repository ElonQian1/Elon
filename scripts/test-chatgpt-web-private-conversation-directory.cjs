...
assert(directoryRequestsSource.includes('conversationAdapter.requestList(command, event =>'));
assert(directoryRequestsSource.includes('requestId: command.requestId'));
