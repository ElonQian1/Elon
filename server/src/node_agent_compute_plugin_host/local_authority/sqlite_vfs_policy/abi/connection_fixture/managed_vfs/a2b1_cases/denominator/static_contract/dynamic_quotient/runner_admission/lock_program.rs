...
mod native_acquire_existing_first_shared_busy_close_succeeded;
...
#[cfg(windows)]
use native_acquire_existing_first_shared_busy_close_succeeded::LockNativeAcquireExistingFirstSharedBusyCloseSucceededProgramSpecV1;
pub(super) use native_acquire_existing_first_shared_busy_close_succeeded::NATIVE_ACQUIRE_EXISTING_FIRST_SHARED_BUSY_CLOSE_SUCCEEDED_PROJECTOR_DELTA_V1;
#[cfg(windows)]
...
pub(in super::super) fn run_lock_isolated_for_test(
    ...
    let evidence = match program.case {
        ...
        LockProgramCaseV1::NativeAcquireExistingFirstSharedBusyCloseSucceeded(initialization) => {
            native_acquire_existing_first_shared_busy_close_succeeded::run_isolated_v1(
                exact_test,
                initialization,
                member,
            )
...
enum LockProgramCaseV1 {
    ...
    NativeAcquireExistingFirstSharedBusyCloseSucceeded(
...
#[cfg(test)]
pub(super) fn native_acquire_existing_first_shared_busy_close_succeeded_catalog_row_count_for_test(
) -> usize {
    native_acquire_existing_first_shared_busy_close_succeeded::catalog_row_count_for_test()
}
