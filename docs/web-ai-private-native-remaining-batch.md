...
| Personal sharing/list/revoke and deletion | Reuse [1644 Copy/revoke](reports/chatgpt-private-acceptance-1644.md). [Canvas](reports/chatgpt-canvas-shared-links-20260911.md) private list returned 3 valid rows on 1672 | Canvas rendered UI/Copy/revoke pending; large accounts, workspace/post/bulk and server pagination remain. [Contract](chatgpt-private-shared-links.md) |
