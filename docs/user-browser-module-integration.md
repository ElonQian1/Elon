...
生产首页现在把同一个官方 WebView2 会话作为“官网原生页”标签挂到主窗口；用户可在“聊天”、
ChatGPT/Google 官方页和回答来源网页之间切换。天气、地图、Logo、图片、表格、公式和厂商交互卡片
由官方页原生呈现，一龙消息层继续提供历史、统一输入和安全语义降级。官方页标签与原弹出窗口复用
