...
internal object WebAiPrivateTransportCatalog {
    ...
    private fun entries(): List<Entry> = listOf(
        Entry(
            id = "android_chatgpt_private_library_attachment_v1",
            provider = "chatgpt",
            status = "implemented_device_pending",
            verification = "existing_attachment_owner_and_library_reference_contract_tests",
            productionDefault = true,
            runtimeEnabled = true,
            requestMode = "cached_library_reference_to_existing_composer_send_owner",
            healthPolicy = "fresh_selection_context_binding_single_association_no_auto_send",
            fallback = "preserved_draft_and_explicit_library_selection_retry",
        ),
        Entry(
        ...
        Entry(
            ...
            provider = "chatgpt",
            status = "implemented_device_pending",
            verification = "targeted_protocol_and_native_contract_tests",
            productionDefault = true,
            runtimeEnabled = true,
            requestMode = "same_origin_library_nodes_to_native_browser",
            healthPolicy = "identity_bound_cache_single_read_timeout_and_failure_cooldown",
            fallback = "retained_native_rows_retry_or_explicit_official_library",
        ),
        Entry(
            id = "android_chatgpt_private_conversation_files_v1",
            provider = "chatgpt",
            status = "implemented_device_pending",
            verification = "shared_wire_and_targeted_contract_tests_passed",
            productionDefault = true,
            runtimeEnabled = BuildConfig.CHATGPT_PRIVATE_CONVERSATION_PREFETCH_ENABLED,
            requestMode = "same_origin_history_get_to_native_attachment_index",
            healthPolicy = "bounded_singleflight_cache_and_exact_pending_request_identity",
            fallback = "retained_native_index_retry_or_explicit_official_options",
        ),
        Entry(
        ...
        Entry(
            id = "android_chatgpt_snapshot_authoritative_handshake_v1",
            provider = "chatgpt",
            status = "completed",
            verification = "device_verified_v1_1_1536_adapter_259_without_manual_resume",
            productionDefault = true,
            runtimeEnabled = true,
            requestMode = "bounded_adapter_reinjection_until_current_document_snapshot",
            healthPolicy = "snapshot_only_acknowledgement_and_existing_session_recovery_budget",
            fallback = "bounded_official_webview_session_recovery",
        ),
        Entry(
