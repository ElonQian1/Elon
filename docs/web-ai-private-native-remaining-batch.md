...
| Independent native file library | Root/folder/search/cursor browsing, cache, downloads, rename/soft-delete and existing-file composer association | Targeted tests pass; installed 1579, live acceptance awaiting sign-in | [Browser/receipt](chatgpt-private-library-browser.md), [mutations](chatgpt-private-library-mutations.md), [attachment](chatgpt-private-library-attachment.md); cold-identity v4 source patch pending next APK; folders/special sources remain open |
