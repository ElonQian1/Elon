    ...
    private fun handleEvent(event: ChatGptWebEvent) {
        ...
        when (event) {
            is ChatGptWebEvent.Snapshot -> {
                ...
                latestSnapshot = snapshot.also { sessionRestorer.onSnapshot(it) { pageAdapter?.requestConversationRefresh() } }
            ...
            is ChatGptWebEvent.ConversationFiles, is ChatGptWebEvent.LibraryFiles,
            is ChatGptWebEvent.CanvasContent, is ChatGptWebEvent.CanvasDocuments, is ChatGptWebEvent.WritingBlock, is ChatGptWebEvent.DirectoryPage -> Unit
