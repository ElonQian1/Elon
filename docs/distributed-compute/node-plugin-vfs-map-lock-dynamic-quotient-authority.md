...
implementation_status: typed_projector_candidate_prior_compiled_map_and_lock_q14_pre_manifest_program_inventory_reviewed_source_admission_and_exact_private_execution_bridge_source_written_uncompiled_unrun
verification_status: prior_targeted_unit_36_passed_current_map_lock_q14_inventory_source_admission_and_private_execution_not_run_review_digests_and_manifests_not_frozen
...
88 个 singleton normalized group；q14 `LockNativeAcquireCreatedFirstTruncateErrorReleaseSucceededV1` 再把 CreatedFirst +
DMS truncate outcome uncertain + release success observed 的相同 44×2 组合写成 88 个 singleton。故 q1–q14 未运行 inventory 预期为
`3,932 present members / 3,932 present groups / 4,736 missing members / 4,208 missing groups /
8,668 total members / 8,140 total groups`。完整 initialization umbrella 仍缺 3,168 members / 2,640
groups。q9–q14 的成员、production/controlled-fault actual chain、receipt 和排除边界由
...
以及 Lock stored-poison 两 completion 与 q5–q14 exact tranche 的 program/catalog/source-scope/runner seams；
...
88、q9 为 528、q10 为 7、q11 为 11、q12/q13/q14 各为 88；仍缺 4,736 members / 4,208 groups、编译/运行、actual
...
CreatedFirst/ExistingFirst DMS release 点故意丢弃 `UnlockFileEx` BOOL 的 receipt，以及 q14 在 CreatedFirst
DMS truncate 点故意丢弃真实 `File::set_len(0)` Result、随后观察 normal production release success 的 receipt 都只是
source-only shape。
...
`source_written/source_review_only/implementation_uncompiled/implementation_unrun`。Map q3/q4 与 Lock 10+104、q3-q14 的 receipt/inventory/admission/binding source 均为 `passed=0/failed=0/not_run`；prior `36/36` 不是 current 验证。
...
lock_program_inventory_unrun_test_expectation=members_8668_groups_8140_source_present_members_3932_source_present_groups_3932_planned_missing_members_4736_planned_missing_groups_4208
...
lock_source_program_admission_current=unconstructible_unrun_source_expectation_planned_missing_members_4736_planned_missing_groups_4208_compile_runtime_actual_receipts_and_reviewed_digest_absent
...
lock_q3_q4_stored_poison_q5_native_busy_q6_local_sibling_contention_q7_callback_completion_route_unknown_q8_local_protocol_rejection_q9_pre_managed_callback_rejection_q10_abi_scalar_rejection_q11_raw_state_rejection_q12_created_first_exclusive_release_error_q13_existing_first_exclusive_release_error_q14_created_first_truncate_error_release_succeeded_windows_execution=not_run
global_source_leaf_authority_scope=static_confirmed_preexisting_q9_q14_drift_19_artifact_refresh_independently_deferred_production_sources_including_current_managed_namespace_and_managed_shm_root_not_rebound_separate_rebind_required_before_compile_or_runtime_acceptance
compilation=not_run
cargo=not_run
