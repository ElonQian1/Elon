...
function New-Fb2GapValidation {
    ...
    if (@($plannedP4Vector).Count -gt 0) {
        ...
        Add-Fb2GapCheck $checks "planned p4 source enumerator report version" ([string](Get-Fb2GapProperty $p4 "source_enumerator_report_version" "") -eq "fb2_p4_source_enumerator_v1")
        Add-Fb2GapCheck $checks "planned p4 source enumerator status" ([string](Get-Fb2GapProperty $p4 "source_enumerator_status" "") -eq "source_specific_no_write_sample_available")
        Add-Fb2GapCheck $checks "planned p4 source enumerator checked count delegated" ([string](Get-Fb2GapProperty $p4 "source_enumerator_checked_count" "") -eq "reported_by_fb2_source_enumerator_runtime")
        Add-Fb2GapCheck $checks "planned p4 source enumerator known chunk count delegated" ([string](Get-Fb2GapProperty $p4 "source_enumerator_known_chunk_count" "") -eq "reported_by_fb2_source_enumerator_runtime")
        Add-Fb2GapCheck $checks "planned p4 chunk manifest report version" ([string](Get-Fb2GapProperty $p4 "chunk_manifest_report_version" "") -eq "fb2_p4_chunk_manifest_v1")
        Add-Fb2GapCheck $checks "planned p4 chunk manifest status" ([string](Get-Fb2GapProperty $p4 "chunk_manifest_status" "") -eq "id_only_no_write_manifest_available")
        Add-Fb2GapCheck $checks "planned p4 chunk manifest entry count delegated" ([string](Get-Fb2GapProperty $p4 "chunk_manifest_materialized_entry_count" "") -eq "reported_by_fb2_chunk_manifest_runtime")
        Add-Fb2GapCheck $checks "planned p4 chunk manifest scope complete delegated" ([string](Get-Fb2GapProperty $p4 "chunk_manifest_current_scope_complete" "") -eq "reported_by_fb2_chunk_manifest_runtime")
        ...
        Add-Fb2GapCheck $checks "planned p4 embedding transaction preflight report version" ([string](Get-Fb2GapProperty $p4 "embedding_transaction_preflight_report_version" "") -eq "fb2_p4_embedding_transaction_preflight_v1")
        Add-Fb2GapCheck $checks "planned p4 embedding transaction preflight no-write status" ([string](Get-Fb2GapProperty $p4 "embedding_transaction_preflight_status" "") -eq "transaction_preflight_available_no_writes")
        ...
        Add-Fb2GapCheck $checks "planned p4 disabled embedding skeleton report version" ([string](Get-Fb2GapProperty $p4 "disabled_embedding_skeleton_report_version" "") -eq "fb2_p4_disabled_embedding_skeleton_v1")
        Add-Fb2GapCheck $checks "planned p4 provider write implementation shape report version" ([string](Get-Fb2GapProperty $p4 "provider_write_implementation_shape_report_version" "") -eq "fb2_p4_provider_write_implementation_shape_v1")
        Add-Fb2GapCheck $checks "planned p4 disabled adapter write-store report version" ([string](Get-Fb2GapProperty $p4 "disabled_adapter_write_store_report_version" "") -eq "fb2_p4_disabled_adapter_write_store_v1")
        Add-Fb2GapCheck $checks "planned p4 runtime approval checklist report version" ([string](Get-Fb2GapProperty $p4 "runtime_approval_checklist_report_version" "") -eq "fb2_p4_runtime_approval_checklist_v1")
        Add-Fb2GapCheck $checks "planned p4 migration approval packet report version" ([string](Get-Fb2GapProperty $p4 "migration_approval_packet_report_version" "") -eq "fb2_p4_migration_approval_packet_v1")
        Add-Fb2GapCheck $checks "planned p4 post-migration verification plan report version" ([string](Get-Fb2GapProperty $p4 "post_migration_verification_plan_report_version" "") -eq "fb2_p4_post_migration_verification_plan_v1")
        Add-Fb2GapCheck $checks "planned p4 requirement traceability report version" ([string](Get-Fb2GapProperty $p4 "requirement_traceability_report_version" "") -eq "fb2_ai_context_requirement_traceability_v1")
        Add-Fb2GapCheck $checks "planned p4 answer handoff report version" ([string](Get-Fb2GapProperty $p4 "answer_handoff_report_version" "") -eq "main_project_answer_handoff_markdown")
        Add-Fb2GapCheck $checks "planned p4 blocker phase matrix version" ([string](Get-Fb2GapProperty $p4 "p4_blocker_phase_matrix_version" "") -eq "p4_blocker_phase_matrix")
        Add-Fb2GapCheck $checks "planned p4 phase approvals all false" ([bool](Get-Fb2GapProperty $p4 "p4_phase_approvals_all_false" $false))
        Add-Fb2GapCheck $checks "planned p4 business context status" ([string](Get-Fb2GapProperty $p4 "business_context_status" "") -eq "business_context_requirements_traceable_final_goal_still_open")
        Add-Fb2GapCheck $checks "planned p4 business data requirements traceable" ([bool](Get-Fb2GapProperty $p4 "business_data_requirements_traceable" $false))
        Add-Fb2GapCheck $checks "planned p4 full original goal not complete" (-not [bool](Get-Fb2GapProperty $p4 "full_original_goal_complete" $true))
        Add-Fb2GapCheck $checks "planned p4 final completion blocker" ([string](Get-Fb2GapProperty $p4 "final_completion_blocker" "") -eq "p4_vector_rag_planned_not_approved_or_enabled")
        Add-Fb2GapCheck $checks "planned p4 approval not granted" (-not [bool](Get-Fb2GapProperty $p4 "p4_approval_granted" $true))
        Add-Fb2GapCheck $checks "planned p4 not executable now" (-not [bool](Get-Fb2GapProperty $p4 "p4_executable_now" $true))
        ...
        Add-Fb2GapCheck $checks "planned p4 chunk manifest file not written" (-not [bool](Get-Fb2GapProperty $p4 "writes_chunk_manifest_file" $true))
        ...
        Add-Fb2GapCheck $checks "planned p4 source enumerator writes no feedback or adoption" (-not [bool](Get-Fb2GapProperty $p4 "writes_feedback_or_adoption" $true))
        ...
        Add-Fb2GapCheck $checks "planned p4 shadow eval not ready" (-not [bool](Get-Fb2GapProperty $p4 "ready_for_shadow_eval" $true))
        Add-Fb2GapCheck $checks "planned p4 answer-time candidates disabled" (-not [bool](Get-Fb2GapProperty $p4 "answer_time_vector_candidates_enabled" $true))
