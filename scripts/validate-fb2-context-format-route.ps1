...
function New-Fb2ContextFormatRouteValidation {
    ...
    Add-Fb2FormatCheck $checks `
        ...
        (Test-Fb2FormatAllTokens $texts.readme @("a555efd7", "fb2_p4_vector_readiness_plan_v1", "fb2_p4_vector_contract_v1", "fb2_p4_source_enumerator_v1", "fb2_p4_chunk_manifest_v1", "fb2_p4_embedding_build_dry_run_v1", "fb2_p4_embedding_transaction_preflight_v1", "source_specific_no_write_sample_available", "id_only_no_write_manifest_available", "not_checked_missing_current_user_scope", "not_checked_missing_platform_scope", "contract_design_committed_embedding_not_started", "dry_run_available_no_writes", "transaction_preflight_available_no_writes", "production_grounding=false", "answer_time_vector_candidates_enabled=false", "writes_chunk_manifest_file=false", "persists_manifest_rows=false", "persists_transaction_rows=false", "creates_or_migrates_tables=false", "calls_embedding_provider=false", "source_payload_included=false", "embedding_text_included=false", "writes_embedding_rows=false", "writes_vector_store=false", "writes_public_group_messages=false", "ready_to_execute_embedding_transaction=false", "ready_to_write_embeddings=false", "ready_for_shadow_eval=false", "refresh_operations_used=false", "candidate_rows_require_live_hydration=true", "vector_rows_are_model_input=false", "does_not_enable_vector=true", "ready_to_build_embedding_store=false", "ready_to_enable_answer_time_vector_candidates=false", "生产 grounding")) `
        $files.readme `
    ...
    Add-Fb2FormatCheck $checks `
        ...
        (Test-Fb2FormatAllTokens $texts.handoff @("a555efd7", "fb2_p4_vector_readiness_plan_v1", "fb2_p4_vector_contract_v1", "fb2_p4_source_enumerator_v1", "fb2_p4_chunk_manifest_v1", "fb2_p4_embedding_build_dry_run_v1", "fb2_p4_embedding_transaction_preflight_v1", "source_specific_no_write_sample_available", "id_only_no_write_manifest_available", "not_checked_missing_current_user_scope", "not_checked_missing_platform_scope", "contract_design_committed_embedding_not_started", "dry_run_available_no_writes", "transaction_preflight_available_no_writes", "p4_vector_readiness_status=planned", "production_grounding=false", "blocks_data_goal=false", "answer_time_vector_candidates_enabled=false", "writes_chunk_manifest_file=false", "persists_manifest_rows=false", "persists_transaction_rows=false", "creates_or_migrates_tables=false", "calls_embedding_provider=false", "source_payload_included=false", "embedding_text_included=false", "writes_embedding_rows=false", "writes_vector_store=false", "writes_public_group_messages=false", "ready_to_execute_embedding_transaction=false", "ready_to_write_embeddings=false", "ready_for_shadow_eval=false", "refresh_operations_used=false", "candidate_rows_require_live_hydration=true", "vector_rows_are_model_input=false", "does_not_enable_vector=true", "ready_to_build_embedding_store=false", "ready_to_enable_answer_time_vector_candidates=false", "answer-time grounding")) `
        $files.handoff `
