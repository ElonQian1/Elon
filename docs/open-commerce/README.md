...
| 消费者发现、关系授权与第三方应用接入 | 跨项目目录、商户声明来源与新鲜度、五种用户可选透明非付费排序器、可复核未签名单次排序凭证、匿名关系、低敏偏好披露、客户端加密敏感数据保险箱、删除请求、有界催办与升级关注、商户提交的未核验外部证明、V5 可验证导出、隔离导入、单包字段级采用、多来源偏好冲突选择、Schema 调用、动作确认、授权与预算、调用事件和封禁主干已形成；来源新鲜度、排序器、凭证、跟进、保险箱、证明、V5、多来源合并、生产准入与 Webhook 等批次未编译，生产能力默认关闭。外部同步回执绑定、运营方签名排序凭证、第三方排序器 SDK、自动删除通知与仲裁、密码找回、多设备密钥同步、商户或 AI 授权解密、完整订单迁移、外部删除执行与回执核验、跨运营方身份互认与生产公共网络仍未完成 | `docs/decisions/open-commerce-directory-publication-v1.md`、`docs/decisions/open-commerce-public-data-provenance-v1.md`、`docs/decisions/open-commerce-pluggable-ranking-v1.md`、`docs/decisions/open-commerce-consumer-ranking-receipts-v1.md`、`docs/decisions/open-commerce-consumer-relationships-v1.md`、`docs/decisions/open-commerce-consumer-preference-disclosures-v1.md`、`docs/decisions/open-commerce-consumer-data-vault-v1.md`、`docs/decisions/open-commerce-consumer-data-request-followups-v1.md`、`docs/decisions/open-commerce-consumer-data-erasure-evidence-v1.md`、`docs/decisions/open-commerce-consumer-portability-exports-v5.md`、`docs/decisions/open-commerce-consumer-portability-imports-v1.md`、`docs/decisions/open-commerce-consumer-portability-selective-adoption-v1.md`、`docs/decisions/open-commerce-consumer-portability-multi-source-merge-v1.md`、`docs/decisions/open-commerce-developer-terminal-events-v1.md`、`docs/decisions/open-commerce-developer-production-credentials-v1.md`、`docs/decisions/open-commerce-production-webhooks-v1.md` |
