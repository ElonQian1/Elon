...
| Model/effort/tool combinations | Normal 1625 private catalog, Advanced/version selection reused; 1627 passed cached native High/Extreme selection and restoration. Native new blank chat and temporary on/off each passed private receipt/state confirmation; [evidence](reports/chatgpt-composer-state-20260910.md#normal-1627-recovery-and-acceptance) | Native tool selection hit premature catalog cancellation on 1627 while direct private read passed; coordinator follow-up pending. Physical drag, other model/tier/tool and temporary contexts, subsequent send and server preference persistence remain unclaimed |
