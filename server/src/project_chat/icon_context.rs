...
pub(super) fn append_project_icon_context(
    state: &AppState,
...
pub(super) fn should_append_project_icon_context_for_pc_fast_path(
    needs_project_workflow: bool,
) -> bool {
    needs_project_workflow
}

pub(super) fn looks_like_replaced_unicode_mojibake(message: &str) -> bool {
...
pub(super) fn append_nonempty_ws_text(buffer: &mut String, text: Option<&str>) {
