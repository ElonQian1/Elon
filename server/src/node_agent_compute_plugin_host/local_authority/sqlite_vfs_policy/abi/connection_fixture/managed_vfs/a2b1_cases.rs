...
//! scaffold, and the commit-bound source-owner graph. Terminal source closure, exact keys,
//! Expected, StaticContract, denominator, and dynamic SQLite/Win32 evidence remain pending.
