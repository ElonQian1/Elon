...
| Share/delete/conversation files | Native pin/rename/archive/move; private file index; scoped private download authorization/native transfer candidate | Verify the integrated ordinary-file download and cover project/library/image scope resolution. Share/delete contracts, reconciliation and destructive confirmation remain. Do not substitute system sharing for official features. |
