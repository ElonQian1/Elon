...
| 外部算力池适配器与统一报价 | V273源码/迁移21/21但production runtime未运行；V274/V277/V278 private源码均为`source_written/source_review_only/implementation_uncompiled/implementation_unrun`、0/0。#13-#18仍deny，Provider=`registering`、`eligible_rows=0`。V280纵切及profile/approval-evidence/admission/projection/Gateway-session-validator五层ABI已设计冻结；initial evidence/inventory和external semantic wire profile未选择，table/migration/source/validator/Runner仍absent，整体unwired/uncompiled/unrun 0/0。见[`V280 vertical`](external-pool-service-managed-admission-runner-authority.md)、[`profile`](external-pool-service-managed-market-profile-authority.md)、[`approval evidence`](external-pool-service-managed-market-profile-approval-evidence-abi-authority.md)、[`admission`](external-pool-service-managed-admission-receipt-abi-authority.md)、[`projection`](external-pool-service-managed-market-projection-identity-abi-authority.md)、[`Gateway/session`](external-pool-service-managed-gateway-session-validator-abi-authority.md)、[`V278`](external-pool-adapter-route-renewal-reachability-authority.md)与[`当前状态`](current-implementation-status.md) |
...
49. `docs/distributed-compute/external-pool-service-managed-admission-runner-authority.md` 与对应 acceptance：V280只冻结受管Pool/Offer准入、两段Gateway、task session、sealed validator、Runner与恢复的完整纵切架构；无源码、migration或fence开放。
...
53. `docs/distributed-compute/external-pool-service-managed-gateway-session-validator-abi-authority.md` 与对应 acceptance：冻结V280 Plan-derived production fence、Gateway final builders、八根task-session custody与五类validator内部ABI；external Adapter semantic wire profile仍未选择，源码与caller为0。
