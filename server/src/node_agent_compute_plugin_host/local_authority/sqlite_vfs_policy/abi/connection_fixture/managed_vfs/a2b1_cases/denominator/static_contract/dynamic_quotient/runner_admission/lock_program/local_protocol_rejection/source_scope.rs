//! Domain-separated implementation seals for exact q8 local protocol rejections.
...
use super::LockLocalProtocolRejectionPathSpecV1;
...
pub(super) fn digest_implementation_v1(
    ...
    hasher.update([
        match path {
            LockLocalProtocolRejectionPathSpecV1::OwnOverlap => 1,
            LockLocalProtocolRejectionPathSpecV1::NotHeld => 2,
        },
