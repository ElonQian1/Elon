...
| Fresh independent text dispatch | ChatGPT | Completed/default-enabled for existing personal plain text on 1696. New first-send/root reconciliation, native receipt and duplicate-answer repairs published in 1720; exact first-send readback passed, follow-up deferred after foreground change | Accepted sender only before dispatch; uncertain writes never replay. New/tool/file/project/temporary and initial composer-free scopes remain. [Baseline](chatgpt-fresh-text-dispatch.md), [1720](reports/chatgpt-fresh-canonical-root-20260914.md) |
