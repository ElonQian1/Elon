...
| Share/delete/conversation files | Native management for pin/rename/archive/move; advanced official options | Confirm operation-specific contracts, reconciliation, and explicit destructive confirmation. Do not substitute Android sharing/TTS for official features. |
