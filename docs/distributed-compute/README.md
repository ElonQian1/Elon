...
| 外部算力池适配器与统一报价 | v221-v260 前置门为 `implementation_partially_verified`。V255/V256/V258/V259 分别为 12/14/11/13 项；V257 已通过 4 项 WSL2 kernel fixture 与 7 项 source-contract。V260 再通过 6 项 source-contract、Linux-musl product/test build 和 5 项 WSL2 kernel fixture，验证 anonymous authenticated seqpacket、mutual bootstrap、方向/序号/篡改/重放/反射/超限与 terminal fail-close；仍不 spawn/exec/capsule/real-secret/network/probe/route/activation。Linux supervisor enforcement、fd3/fd5 跨 exec 与 1 MiB positive boundary 未验收，V254 18 deny 不变。见 [`V260 session 权威`](external-pool-adapter-authenticated-child-session-authority.md)、[`V260 验收`](external-pool-adapter-authenticated-child-session-acceptance.md)、[`V259 companion 权威`](external-pool-adapter-supervisor-session-policy-companion-authority.md) 与 [`当前状态`](current-implementation-status.md) |
...
Provider Adapter 的 v227-v260 前置门已形成分层权威。V255/V256/V258/V259 分别通过 12/14/11/13 项；V257 已在 WSL2 通过 4 项 kernel fixture 与 7 项 source-contract，验证 sealed memfd 但未执行 capsule。V260 新增 independent authenticated child-only session core，6 项 source-contract、Linux-musl product/test build 和 5 项 WSL2 kernel fixture 通过，真实验证 anonymous seqpacket/seed pipe、HKDF/HMAC mutual bootstrap、双向 frame 及 tamper/replay/order/reflection/oversize/terminal fail-close。V260 仍不 spawn/exec/capsule/real-secret/network/probe/activation，且 fd3/fd5 跨 exec、supervisor 级 Linux enforcement 与 1 MiB positive boundary 未验收；之后才可绑定 V258 target 做 broker TLS/upstream probe。V254 18 deny 逐字保留，完整 admission gate 只能与 atomic activation 同批替换。见 [`V260 authenticated session`](external-pool-adapter-authenticated-child-session-authority.md)、[`V259 supervisor/session companion`](external-pool-adapter-supervisor-session-policy-companion-authority.md)、[`V258 upstream target`](external-pool-adapter-upstream-transport-target-authority.md)、[`V257 entrypoint capsule`](external-pool-adapter-entrypoint-capsule-authority.md) 与 [`current-implementation-status.md`](current-implementation-status.md)。
