...
pub async fn get_external_app_context_contract(
    ...
    Json(json!({
        ...
        "context_quality_contract": public_context_quality_guidance(app.id).unwrap_or_else(|| json!({
            "app_id": app.id,
        ...
        "context_projection_layer_contract": public_context_projection_layer_guidance(app.id).unwrap_or_else(|| json!({
            "app_id": app.id,
            "schema": "external_app.context_projection_layer.v1",
            "complete": false,
            "domain_lanes": [],
            "domain_indexes": [],
            "user_scenarios": []
