...
| 消费者可携带数据包 V3 / 外部包隔离导入 / 运营方 RSA 签名 / 低敏偏好采用与回滚 / 本地口令加密归档 | `docs/decisions/open-commerce-consumer-portability-exports-v3.md`、`docs/decisions/open-commerce-consumer-portability-imports-v1.md`、`docs/decisions/open-commerce-consumer-portability-trust-v1.md`、`docs/decisions/open-commerce-consumer-portability-adoption-v1.md`、`docs/decisions/open-commerce-consumer-portability-encrypted-archives-v1.md`、`server/src/open_commerce_portability_*.rs`、`server/src/store/open_commerce_consumer_portability*.rs`、`sdk/open-commerce-connector/src/portability-signature.js`、`portability-archive.js`、`pc-frontend/src/features/open-commerce/ConsumerPortabilityExports.tsx`、`ConsumerPortabilityImports.tsx`、`ConsumerPortabilityTrustKeys.tsx`、`ConsumerPortabilityAdoptions.tsx`、`portabilityArchive.ts` |
