...
| 任务级分布式算力联邦 / Provider、Offer、Job、Reservation、Attempt、验证回执与 CNY 账本 / external-pool V249-V272 roots、readiness、route source bridge 与 ELTP conformance | `docs/distributed-compute/README.md`、`docs/distributed-compute/current-implementation-status.md`、`docs/distributed-compute/external-pool-adapter-task-protocol-conformance-authority.md`、`docs/distributed-compute/external-pool-adapter-task-protocol-conformance-acceptance.md`、`docs/distributed-compute/external-pool-route-source-projection-bridge-authority.md`、`docs/distributed-compute/external-pool-route-source-projection-bridge-acceptance.md`、`docs/distributed-compute/external-pool-adapter-provider-runtime-readiness-authority.md`、`docs/distributed-compute/external-pool-adapter-provider-runtime-readiness-acceptance.md`、`docs/distributed-compute/external-pool-adapter-runtime-compatibility-signing-handoff-authority.md`、`docs/distributed-compute/external-pool-adapter-signed-runtime-compatibility-authority.md`、`docs/distributed-compute/external-pool-adapter-post-exec-supervisor-hardening-authority.md`、`docs/distributed-compute/external-pool-adapter-broker-tls-transport-authority.md`、`docs/distributed-compute/external-pool-adapter-ephemeral-secret-delivery-authority.md`、`docs/distributed-compute/external-pool-adapter-supervisor-session-policy-companion-authority.md`、`docs/distributed-compute/external-pool-adapter-upstream-transport-target-authority.md`、`docs/distributed-compute/external-pool-adapter-runtime-bundle-resolver-authority.md`、`docs/distributed-compute/external-pool-provider-activation-candidate-authority.md`、`docs/distributed-compute/external-pool-adapter-credential-reattestation-authority.md`、`docs/distributed-compute/external-pool-adapter-registry-authority.md`、`docs/distributed-compute/market-and-settlement.md` |
