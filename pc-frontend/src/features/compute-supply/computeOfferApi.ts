...
export interface MyComputeOfferView {
  offer: {
    ...
    runtime: { runtime_family: string; runtime_version: string; precision: string; runner_digest: string }
    ...
    price_terms: { pricing_mode: string; currency: string; components: ComputePriceComponent[]; fee_rules: ComputeFeeRule[]; valid_until: string }
    valid_from: string
    valid_until: string
    created_at: string
  }
