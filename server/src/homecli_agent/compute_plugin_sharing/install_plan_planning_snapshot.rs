    ...
    > {
            ...
            .await
        {
            return Err(match error {
                super::super::legacy_message_fencing::LegacyMessageDispatchError::SessionChanged => planning_failure(
                    "session_replaced",
                    "COMPUTE_PLUGIN_PLANNING_SNAPSHOT_SESSION_REPLACED",
                ),
                super::super::legacy_message_fencing::LegacyMessageDispatchError::RequestAlreadyPending => planning_failure(
                    "dispatch_failed",
                    "COMPUTE_PLUGIN_PLANNING_SNAPSHOT_REQUEST_ALREADY_PENDING",
                ),
                super::super::legacy_message_fencing::LegacyMessageDispatchError::WriterClosed => planning_failure(
                    "writer_closed",
