...
| 节点插件候选验证与 ZIP 受控解包 / create-new staging、逐文件 SHA-256/fsync/同句柄复验、线性保管权 / `implementation_uncompiled` | `docs/distributed-compute/node-plugin-archive-extraction.md`、`docs/distributed-compute/node-plugin-local-authority.md`、`server/src/node_agent_compute_plugin_host/candidate_extraction/`、`server/src/node_agent_compute_plugin_host/fetch_file/staging.rs`、`server/src/node_agent_managed_fs/copy.rs` |
