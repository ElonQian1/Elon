...
| Personal sharing/list/revoke and deletion | Reuse [1644 Copy/revoke](reports/chatgpt-private-acceptance-1644.md), [Canvas list 1673](reports/chatgpt-canvas-shared-links-20260911.md). [Canvas source/update](reports/chatgpt-canvas-edit-publish-contract-20260912.md) implemented, device acceptance pending | Canvas revoke needs a disposable link; original edit/first-publication, workspace/post/bulk and server pagination remain |
