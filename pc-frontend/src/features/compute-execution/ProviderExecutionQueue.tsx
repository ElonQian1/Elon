...
import { Activity, Clock3, LoaderCircle, LockKeyhole, Server } from 'lucide-react'
...
export default function ProviderExecutionQueue({ candidates, leases, loading, selectedLeaseId, onSelectLease }: Props) {
  ...
  return <section className={styles.queue}>
    <header><div><h2>履约队列</h2><span>选择已有 Lease，或检查待激活 Reservation</span></div></header>
