...
| 消费者能力执行计划 / 输入预检 / 授权与动作下一步 | `docs/decisions/open-commerce-consumer-capability-execution-plan-v1.md`、`docs/open-commerce-consumer-capability-execution-plan-v1-acceptance.md`、`server/src/open_commerce_consumer_execution_plan.rs`、`server/src/open_commerce_consumer_discovery_mcp.rs` |
| 消费者 AI 单能力授权申请 / 用户确认 / 商户人工决定 | `docs/decisions/open-commerce-consumer-authorization-mcp-v1.md`、`docs/open-commerce-consumer-authorization-mcp-v1-acceptance.md`、`server/src/open_commerce_consumer_discovery_mcp.rs`、`server/src/store/open_commerce_authorization_requests.rs` |
...
| 消费者本人授权状态与 pending 撤回 / 用户项目隔离 / Grant 结果 | `docs/decisions/open-commerce-consumer-authorization-status-mcp-v1.md`、`docs/open-commerce-consumer-authorization-status-mcp-v1-acceptance.md`、`server/src/open_commerce_consumer_authorization_mcp.rs`、`server/src/store/open_commerce_authorization_requests.rs` |
...
| 任务级分布式算力联邦 / Provider、Offer、Job、Lease、验证回执、期货锁价 / 未编译领域合同、按需插件 Manifest/Plan/双槽生命周期/ReadyCapability、Attempt 与 typed events | `docs/distributed-compute/README.md`、`docs/decisions/distributed-compute-federation-v1.md`、`docs/distributed-compute/architecture.md`、`docs/distributed-compute/node-client-and-plugins.md`、`docs/distributed-compute/market-and-settlement.md`、`server/src/compute_federation/`、`server/src/node_agent_compute_plugin_host/plugin_manifest.rs`、`server/src/node_agent_compute_plugin_host/install_plan.rs`、`server/src/node_agent_compute_plugin_host/lifecycle.rs`、`server/src/node_agent_compute_plugin_host/ready_capability.rs`、`server/src/node_agent_compute_plugin_host/attempt_contract.rs`、`server/src/node_agent_compute_plugin_host/runner_events.rs` |
