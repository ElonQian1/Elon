...
| 任务级分布式算力联邦 / Provider、Offer、Job、Reservation、Lease、验证回执、期货锁价 / `implementation_uncompiled` v169-v174 版本注册表、按需插件与 Attempt 合同 | `docs/distributed-compute/README.md`、`docs/decisions/distributed-compute-federation-v1.md`、`docs/distributed-compute/architecture.md`、`docs/distributed-compute/node-client-and-plugins.md`、`docs/distributed-compute/market-and-settlement.md`、`server/src/compute_federation/`、`server/src/store/compute_provider_registry.rs`、`server/src/store/compute_offer_contract_validation.rs`、`server/src/store/compute_offer_registry.rs`、`server/src/store/compute_price_snapshot_validation.rs`、`server/src/store/compute_price_snapshot_registry.rs`、`server/src/store/compute_job_contract_validation.rs`、`server/src/store/compute_job_registry.rs`、`server/src/store/compute_reservation_contract_validation.rs`、`server/src/store/compute_reservation_registry.rs`、`server/src/compute_provider_migration.rs`、`server/src/compute_offer_migration.rs`、`server/src/compute_price_snapshot_migration.rs`、`server/src/compute_job_migration.rs`、`server/src/compute_capacity_claim_history_migration.rs`、`server/src/compute_reservation_migration.rs`、`server/src/node_agent_compute_plugin_host/` |
