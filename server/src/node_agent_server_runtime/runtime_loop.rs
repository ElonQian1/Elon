...
pub(super) struct RuntimeLoopOptions<'a> {
    pub(super) req_id: &'a str,
    pub(super) label: &'a str,
    pub(super) guard: ToolGuard,
    pub(super) prompt: &'a str,
    pub(super) approval_state: Option<ToolApprovalState>,
    pub(super) cancel_rx: watch::Receiver<bool>,
    pub(super) out_tx: mpsc::UnboundedSender<Message>,
    pub(super) task_journal: Option<TaskJournal>,
    pub(super) initial_model: Option<String>,
}

pub(super) async fn run_runtime_loop<F, Fut>(
