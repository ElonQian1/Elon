...
A2b1 current source baseline `e3663e109039f38477de4d6ab5cd57483dbd0541` 的 owner graph 已续绑 JointClose 影响 owner，并在 ledger evidence commit `bfa1a1180d220e9a4c8e39251414fc9a1b0a9ace` 通过 `4/4`；state-abandon witness 不改变 fallback、Pending=5 或 resolved cross-links=9，也不开放 map/lock 动态验收。指纹与复测元组见[`动态验收 § 当前 A2b1 静态守卫证据`](node-plugin-vfs-fault-acceptance.md#当前-a2b1-静态守卫证据)。
