...
import { CircleCheck, LoaderCircle, Network, RefreshCw, ShieldAlert, ShieldX } from 'lucide-react'
...
export default function ActivationPlanPanel({ request, onChanged }: Props) {
  ...
  return <section className={styles.panel}>
    ...
    {error && !prepareOpen && !applyOpen && !quarantineOpen && <div className={styles.error}>{error}</div>}
