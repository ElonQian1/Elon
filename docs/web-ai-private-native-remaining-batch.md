...
| Personal sharing/list/revoke and deletion | Reuse [1644](reports/chatgpt-private-acceptance-1644.md), [Canvas 1673](reports/chatgpt-canvas-shared-links-20260911.md). [Editor, history/restore and first share](reports/chatgpt-canvas-history-first-share-20260912.md) implemented; source/update also await device | Grouped editor/share acceptance, disposable-link revoke, workspace/post/bulk and pagination remain |
