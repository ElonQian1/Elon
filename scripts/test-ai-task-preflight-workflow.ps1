...
Assert-Contains $preflightContent "RULE_BEFORE_COMMIT=" "PowerShell preflight must run source-size checks before commit."
Assert-Contains $preflightShContent "RULE_BEFORE_COMMIT=" "Shell preflight must run source-size checks before commit."
