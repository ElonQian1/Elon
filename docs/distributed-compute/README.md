...
| Provider / Offer / Job / Reservation / Lease / Receipt 统一领域合同 | 基础代码、v169-v176 注册表、Broker Reserve/未执行任务终态及 v185 首次 Attempt 已接受激活回执已写，状态为 `implementation_uncompiled`，尚未迁移、完整接线和运行验证 |
...
15. 现有兼容实现：`docs/decisions/node-compute-sharing-supply-v1.md`。
