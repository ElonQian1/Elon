...
| Independent native file library | ChatGPT | Root/folders/search/pagination/cache and ordinary library downloads implemented in source; [contract and pending acceptance](chatgpt-private-library-browser.md) | Retained rows on refresh failure; explicit official library, no automatic navigation |
