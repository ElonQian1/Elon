...
implementation_status: typed_projector_candidate_prior_compiled_map_and_lock_q19_source_written_uncompiled_unrun
verification_status: prior_targeted_unit_36_passed_current_map_lock_q19_static_only_not_run_actual_not_run_review_digests_and_manifests_not_frozen
...
program；q12/q13 `LockNativeAcquire{CreatedFirst,ExistingFirst}ExclusiveReleaseErrorV1` 把两种 initialization path +
DMS exclusive release outcome uncertain 的 44 个合法 acquire request × 两个 unsafe terminal completion 各精确写成
88 个 singleton normalized group；q14/q15 `LockNativeAcquire{CreatedFirst,ExistingFirst}TruncateErrorReleaseSucceededV1`
再把两种 path + DMS truncate outcome uncertain + release success observed 的相同 44×2 组合各写成 88 个
...
`was_created=false`；q18/q19 `LockNativeAcquire{CreatedFirst,ExistingFirst}SharedBusyCloseSucceededV1` 再把两种
path 的 shared-busy/close-ok 各写成 44×2 singleton，并绑定 same-FileId distinct holder/target 真争用、attempt
分账和 explicit close success；q19 另绑定物理 SHM precreation/cold `was_created=false`，`a2lockq19`=194。

因此 current q1–q19 未运行 inventory 为 `4,372/4,372 present + 4,296/3,768 missing`，total
`8,668/8,140`，q12–q19=`704/704`、initialization remaining=`2,728/2,200`。
q9–q19 合同见 [`Lock dynamic tranches authority`](node-plugin-vfs-lock-dynamic-tranches-authority.md)，共享争用
细节见 [`Lock DMS shared-busy tranches authority`](node-plugin-vfs-lock-shared-busy-tranches-authority.md)。两根均无
current compile/runtime、checked-in reviewed inventory digest、manifest 或 actual acceptance。
...
以及 Lock stored-poison 两 completion、q5–q19 exact source 的
program/catalog/source-scope/runner seams；
...
88、q9 为 528、q10 为 7、q11 为 11、q12–q19 各为 88；current 仍缺 4,296 members / 3,768 groups、编译/运行、actual
...
CreatedFirst/ExistingFirst DMS truncate 点故意丢弃真实 `File::set_len(0)` Result、随后观察 normal production
...
仍 Quarantined。q19 把 q17 的 physical precreation/cold ExistingFirst 与 q18 contention/close-success 组合为
下一个 88-member 对切；两条 seam 都只是 uncompiled/unrun source，不能升格为 actual。
...
`source_written/source_review_only/implementation_uncompiled/implementation_unrun`。Map q3/q4 与 Lock q3-q19 的 receipt/inventory/admission/binding source 均为 `passed=0/failed=0/not_run`；prior `36/36` 不是 current 验证。
...
lock_native_acquire_existing_first_exclusive_release_error_v1=source_written_q13_88_exact_singleton_members_44_legal_acquire_requests_times_2_unsafe_terminal_completions_typed_physical_shm_precreation_receipt_real_existing_first_dms_lock_and_truncate_real_unlockfileex_bool_receipt_deliberately_unread_controlled_fault_actual_only_uncompiled_unrun_details_in_lock_tranches_authority
lock_native_acquire_existing_first_exclusive_release_error_catalog=rows_88_bytes_18474_sha256_03b883842b3fd1886779dcb07573521d14ca3125894b38c4d341a462137424f4
lock_native_acquire_created_first_truncate_error_release_succeeded_v1=source_written_q14_88_exact_singleton_members_44_legal_acquire_requests_times_2_unsafe_terminal_completions_created_first_real_dms_lock_real_file_set_len_result_deliberately_unread_typed_return_receipt_unavailable_normal_production_unlockfileex_success_observed_dms_released_native_lock_unlock_1_1_file_retained_mutation_uncertain_lock_certain_controlled_fault_actual_only_uncompiled_unrun_details_in_lock_tranches_authority
lock_native_acquire_created_first_truncate_error_release_succeeded_catalog=rows_88_bytes_17594_sha256_95f1c8e40da35ac23cc46e20310178c2aef09adacf777155d9b67e5802d69abd
lock_native_acquire_existing_first_truncate_error_release_succeeded_v1=source_written_q15_88_exact_singleton_members_44_legal_acquire_requests_times_2_unsafe_terminal_completions_typed_physical_shm_precreation_receipt_existing_first_real_dms_lock_real_file_set_len_result_deliberately_unread_typed_return_receipt_unavailable_normal_production_unlockfileex_success_observed_dms_released_native_lock_unlock_1_1_file_retained_mutation_uncertain_lock_certain_controlled_fault_actual_only_uncompiled_unrun_details_in_lock_tranches_authority
lock_native_acquire_existing_first_truncate_error_release_succeeded_catalog=rows_88_bytes_17682_sha256_d8ac9985f433b9fbd089a8804136f107cf37bd21566b5852611e98674f52911b
lock_native_acquire_created_first_truncate_error_release_failed_v1=source_written_q16_88_exact_singleton_members_44_legal_acquire_requests_times_2_unsafe_terminal_completions_created_first_real_dms_lock_real_file_set_len_result_deliberately_unread_then_cleanup_unlockfileex_bool_deliberately_unread_two_typed_return_receipts_unavailable_in_order_cleanup_rewrite_false_terminal_cleanup_rewritten_dms_exclusive_outcome_uncertain_native_lock_unlock_1_1_file_retained_mutation_and_lock_uncertain_controlled_fault_actual_only_uncompiled_unrun_details_in_lock_tranches_authority
lock_native_acquire_created_first_truncate_error_release_failed_catalog=rows_88_bytes_18386_sha256_f51b7d0df30afda4a8844ee4c4e227a6cf757b2f7b0c16e0bc0e8dbfaad05718
...
lock_native_acquire_existing_first_shared_busy_close_succeeded_v1=source_written_q19_88_exact_singleton_members_16_shared_plus_72_exclusive_44_each_terminal_completion_physical_precreation_cold_was_created_false_same_file_id_distinct_holder_target_real_contention_target_lock_2_1_1_unlock_1_1_close_1_1_holder_acquire_unlock_1_1_separate_ledgers_controlled_fault_actual_only_uncompiled_unrun
lock_native_acquire_existing_first_shared_busy_close_succeeded_protocol=a2lockq19_payload_expected_194_values_partition_25_5_8_25_8_14_43_15_18_1_18_6_4_3_1
lock_native_acquire_existing_first_shared_busy_close_succeeded_catalog=rows_88_bytes_18210_sha256_eb318d91edbd0bbcd7e68ff626504a007a3f3c96d5eb60b965c9e362a421eee8
...
lock_program_inventory_unrun_test_expectation=members_8668_groups_8140_source_present_members_4372_source_present_groups_4372_planned_missing_members_4296_planned_missing_groups_3768
...
lock_source_program_admission_current=unconstructible_unrun_source_expectation_planned_missing_members_4296_planned_missing_groups_3768_compile_runtime_actual_receipts_and_reviewed_digest_absent
...
lock_q3_q4_stored_poison_q5_native_busy_q6_local_sibling_contention_q7_callback_completion_route_unknown_q8_local_protocol_rejection_q9_pre_managed_callback_rejection_q10_abi_scalar_rejection_q11_raw_state_rejection_q12_created_first_exclusive_release_error_q13_existing_first_exclusive_release_error_q14_created_first_truncate_error_release_succeeded_q15_existing_first_truncate_error_release_succeeded_q16_created_first_truncate_error_release_failed_q17_existing_first_truncate_error_release_failed_q18_created_first_shared_busy_close_succeeded_q19_existing_first_shared_busy_close_succeeded_windows_execution=not_run
global_source_leaf_authority_scope=static_confirmed_preexisting_q9_q14_checkpoint_drift_19_artifact_refresh_overdue_independently_deferred_q15_q16_q17_q18_q19_must_be_included_production_sources_including_current_managed_namespace_and_managed_shm_root_not_rebound_separate_rebind_required_before_compile_or_runtime_acceptance
compilation=not_run
cargo=not_run
...
q15–q19，禁止只重绑 owner/needle 而不重生成并复核完整 frozen set。
