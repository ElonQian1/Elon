...
| Native existing-library attachment | ChatGPT | Native attach/card/remove verified in 1586; private-ID parser correction and explicit send under acceptance; [evidence](chatgpt-private-library-attachment.md) | Preserve draft; no reupload, automatic send or cross-context association |
