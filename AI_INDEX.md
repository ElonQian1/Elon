...
| 项目文档权威性 / 低 token 分类 / OneNote 虚拟分区 / 供应商无关 MCP | `.github/instructions/document-authority.instructions.md`、`docs/project-document-governance-mcp.md`、`server/src/project_document_governance*.rs`、`server/src/node_agent_project_docs_mcp*.rs` |
