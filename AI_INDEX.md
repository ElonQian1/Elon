...
| 跨项目 Rust 缓存、重复 worktree 分区、按需共享接入与回滚 | `.agents/skills/manage-shared-build-cache/SKILL.md`、`docs/rust-cache-on-demand-adoption.md`、`docs/rust-cache-platform.md`、`scripts/rust-cache.ps1` |
