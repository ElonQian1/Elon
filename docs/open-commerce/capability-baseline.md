...
| 消费者 AI 本人 App 目录 | 代码已形成、未编译 | 只读列出当前项目中本人拥有的 App、当前 MCP 身份和沙箱可用状态，不返回任何测试 Token、提示或生产凭据；App 生命周期继续由开发者门户管理 | `server/src/open_commerce_consumer_app_mcp.rs`、`server/src/open_commerce_mcp_protocol.rs`、`docs/decisions/open-commerce-consumer-app-directory-mcp-v1.md` |
