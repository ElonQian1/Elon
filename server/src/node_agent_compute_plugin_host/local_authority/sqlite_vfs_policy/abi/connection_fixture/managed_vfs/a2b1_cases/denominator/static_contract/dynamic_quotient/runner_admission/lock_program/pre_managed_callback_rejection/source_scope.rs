...
pub(super) const PRE_MANAGED_CALLBACK_REJECTION_PROJECTOR_DELTA_V1: &[(&str, &str)] = &[
    ...
    source!("managed_vfs/lifecycle_faults/pre_managed_lock/abi_rejected.rs", "/src/node_agent_compute_plugin_host/local_authority/sqlite_vfs_policy/abi/connection_fixture/managed_vfs/lifecycle_faults/pre_managed_lock/abi_rejected.rs"),
