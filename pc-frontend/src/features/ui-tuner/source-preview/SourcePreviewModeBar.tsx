  ...
  return (
    <div className={styles.modeBar}>
      ...
      {props.mode === 'source' && <>
        ...
        <span className={styles.rendererBackend} title={props.renderer.error || props.renderer.capabilities?.layoutlib.detail}>{props.renderer.render ? 'Android Layoutlib' : 'React 数字孪生'}</span>
