//! Exact q13 source programs for existing-first DMS exclusive-release outcome uncertainty.
//!
...
pub(super) use source_scope::NATIVE_ACQUIRE_EXISTING_FIRST_EXCLUSIVE_RELEASE_ERROR_PROJECTOR_DELTA_V1;
...
pub(super) const EXISTING_FIRST_EXCLUSIVE_RELEASE_ERROR_MEMBER_COUNT: usize = 88;

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(super) enum LockExistingFirstExclusiveReleaseCompletionV1 {
    RetentionSucceeded,
    RetentionRouteUnknown,
}

impl LockExistingFirstExclusiveReleaseCompletionV1 {
...
#[derive(Clone, Copy)]
pub(super) struct LockNativeAcquireExistingFirstExclusiveReleaseErrorProgramSpecV1 {
    #[cfg(windows)]
    ...
    pub(super) mask: u8,
    #[cfg(windows)]
    pub(super) completion: LockExistingFirstExclusiveReleaseCompletionV1,
...
) -> Option<LockExistingFirstExclusiveReleaseCompletionV1> {
    match value {
