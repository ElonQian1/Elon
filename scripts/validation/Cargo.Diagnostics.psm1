...
function Get-CargoFailureDiagnostic {
    ...
    $rules = @(
        ...
        @{ code='CARGO_TLS_FAILURE'; retry=$true; pattern='certificate|SSL|TLS|schannel|peer certificate|UnknownIssuer|InitializeSecurityContext' },
        @{ code='CARGO_PROXY_FAILURE'; retry=$true; pattern='proxy|407 Proxy Authentication|CONNECT tunnel failed' },
