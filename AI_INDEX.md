...
| 消费者客户端加密敏感数据保险箱 / 密文修订 / 本人下载与删除 / 本地密码学与服务端信封校验 | `docs/decisions/open-commerce-consumer-data-vault-v1.md`、`docs/open-commerce-consumer-data-vault-v1-acceptance.md`、`server/src/open_commerce_consumer_vault_*.rs`、`server/src/open_commerce_consumer_vault_service_tests.rs`、`server/src/store/open_commerce_consumer_vault.rs`、`pc-frontend/src/features/open-commerce/consumerDataVaultCrypto.js`、`consumerDataVaultCrypto.d.ts`、`ConsumerDataVaultPanel.tsx`、`scripts/test-open-commerce-consumer-data-vault-crypto.mjs` |
