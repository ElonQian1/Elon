...
mod node_agent_privileged_component;
...
mod node_agent_project_docs_mcp_discussion_review_tools;
mod node_agent_project_docs_mcp_discussion_source_tools;
...
mod node_agent_project_feature_mcp;
mod node_agent_project_feature_tools;
...
mod node_agent_provider_auth_monitor;
...
mod node_agent_web_chat_adapter;
...
mod project_document_retrieval_acceptance;
mod project_document_scoped_health;
mod project_document_section_reader;
mod project_document_vault;
mod project_document_versioning;
mod project_feature_projection;
mod project_feature_registry;
