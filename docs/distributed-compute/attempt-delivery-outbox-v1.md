...
- external-pool onboarding API、credential authority、Provider 激活和 service-managed capacity；领域/Store-private/v221 Store 状态机已验收，但生产入口未实现；
