...
use super::{
    ...
    lock_existing_first_exclusive_release_error, lock_existing_first_shared_busy_close_succeeded,
...
pub(super) fn validate_actual_payload(
    ...
    let (family, expected_value_count) = match version {
        ...
        lock_callback_route_unknown::REPORT_VERSION => (
            SanitizedPayloadFamily::LockQuotient,
            lock_callback_route_unknown::classify_header(version, selector)?
                .ok_or("A2_DYNAMIC_CHILD_ACTUAL_VERSION_INVALID")?,
        ),
        ...
        lock_pre_managed_rejection::REPORT_VERSION => (
            SanitizedPayloadFamily::LockQuotient,
            lock_pre_managed_rejection::classify_header(version, selector)?
                .ok_or("A2_DYNAMIC_CHILD_ACTUAL_VERSION_INVALID")?,
        ),
        lock_local_sibling_contention::REPORT_VERSION => (
            SanitizedPayloadFamily::LockQuotient,
            lock_local_sibling_contention::classify_header(version, selector)?
                .ok_or("A2_DYNAMIC_CHILD_ACTUAL_VERSION_INVALID")?,
        ),
        ...
        lock_abi_scalar_rejection::REPORT_VERSION => (
            SanitizedPayloadFamily::LockQuotient,
            lock_abi_scalar_rejection::classify_header(version, selector)?
                .ok_or("A2_DYNAMIC_CHILD_ACTUAL_VERSION_INVALID")?,
        ),
        ...
        lock_created_first_truncate_error_release_failed::REPORT_VERSION => (
            SanitizedPayloadFamily::LockQuotient,
            lock_created_first_truncate_error_release_failed::classify_header(version, selector)?
                .ok_or("A2_DYNAMIC_CHILD_ACTUAL_VERSION_INVALID")?,
        ),
        lock_created_first_truncate_error_release_succeeded::REPORT_VERSION => (
            SanitizedPayloadFamily::LockQuotient,
            lock_created_first_truncate_error_release_succeeded::classify_header(
                version, selector,
            )?
            .ok_or("A2_DYNAMIC_CHILD_ACTUAL_VERSION_INVALID")?,
        ),
        ...
        lock_existing_first_truncate_error_release_failed::REPORT_VERSION => (
            SanitizedPayloadFamily::LockQuotient,
            lock_existing_first_truncate_error_release_failed::classify_header(version, selector)?
                .ok_or("A2_DYNAMIC_CHILD_ACTUAL_VERSION_INVALID")?,
        ),
        lock_existing_first_truncate_error_release_succeeded::REPORT_VERSION => (
            SanitizedPayloadFamily::LockQuotient,
            lock_existing_first_truncate_error_release_succeeded::classify_header(
                version, selector,
            )?
            .ok_or("A2_DYNAMIC_CHILD_ACTUAL_VERSION_INVALID")?,
        ),
