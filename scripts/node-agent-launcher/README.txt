...
- 创建桌面快捷方式「一龙PC节点」
- 创建开始菜单文件夹「一龙PC节点」，里面集中放启动、打开日志、导出诊断、检查更新、修复客户端和卸载入口
- 注册当前用户登录后的开机自启
...
- 普通用户可以从 Windows 开始菜单打开「一龙PC节点」文件夹，直接选择「打开运行日志」「导出诊断」「检查更新」「修复客户端」或「卸载一龙PC节点」。
...
- 修复客户端入口：
  ...
  "%LOCALAPPDATA%\ElonNode\一龙PC节点.exe" --repair
