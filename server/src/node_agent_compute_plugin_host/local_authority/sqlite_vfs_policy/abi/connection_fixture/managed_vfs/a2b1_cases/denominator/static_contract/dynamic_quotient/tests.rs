...
mod lock_native_acquire_created_first_shared_busy_close_succeeded_cases;
mod lock_native_acquire_created_first_truncate_error_release_failed_cases;
mod lock_native_acquire_created_first_truncate_error_release_succeeded_cases;
mod lock_native_acquire_existing_first_exclusive_release_error_cases;
mod lock_native_acquire_existing_first_shared_busy_close_succeeded_cases;
mod lock_native_acquire_existing_first_truncate_error_release_failed_cases;
mod lock_native_acquire_existing_first_truncate_error_release_succeeded_cases;
mod lock_pre_managed_callback_rejection_cases;
mod lock_program_inventory;
mod lock_program_inventory_q19;
...
mod runner_admission_lock_native_acquire_created_first_shared_busy_close_succeeded_cleanup_source;
mod runner_admission_lock_native_acquire_created_first_shared_busy_close_succeeded_source;
#[cfg(windows)]
mod runner_admission_lock_native_acquire_created_first_shared_busy_close_succeeded_supported;
mod runner_admission_lock_native_acquire_created_first_truncate_error_release_failed_source;
#[cfg(windows)]
mod runner_admission_lock_native_acquire_created_first_truncate_error_release_failed_supported;
mod runner_admission_lock_native_acquire_created_first_truncate_error_release_succeeded_source;
#[cfg(windows)]
mod runner_admission_lock_native_acquire_created_first_truncate_error_release_succeeded_supported;
...
mod runner_admission_lock_native_acquire_existing_first_shared_busy_close_succeeded_cleanup_source;
mod runner_admission_lock_native_acquire_existing_first_shared_busy_close_succeeded_source;
#[cfg(windows)]
mod runner_admission_lock_native_acquire_existing_first_shared_busy_close_succeeded_supported;
mod runner_admission_lock_native_acquire_existing_first_truncate_error_release_failed_source;
#[cfg(windows)]
mod runner_admission_lock_native_acquire_existing_first_truncate_error_release_failed_supported;
mod runner_admission_lock_native_acquire_existing_first_truncate_error_release_succeeded_source;
#[cfg(windows)]
mod runner_admission_lock_native_acquire_existing_first_truncate_error_release_succeeded_supported;
