//! Exact q14 source programs for created-first DMS truncate failure with successful exclusive release.
//!
...
pub(super) use source_scope::NATIVE_ACQUIRE_CREATED_FIRST_TRUNCATE_ERROR_RELEASE_SUCCEEDED_PROJECTOR_DELTA_V1;
...
pub(super) const CREATED_FIRST_TRUNCATE_ERROR_RELEASE_SUCCEEDED_MEMBER_COUNT: usize = 88;

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(super) enum LockCreatedFirstTruncateErrorReleaseSucceededCompletionV1 {
    RetentionSucceeded,
    RetentionRouteUnknown,
}

impl LockCreatedFirstTruncateErrorReleaseSucceededCompletionV1 {
...
#[derive(Clone, Copy)]
pub(super) struct LockNativeAcquireCreatedFirstTruncateErrorReleaseSucceededProgramSpecV1 {
    #[cfg(windows)]
    ...
    pub(super) mask: u8,
    #[cfg(windows)]
    pub(super) completion: LockCreatedFirstTruncateErrorReleaseSucceededCompletionV1,
...
) -> Option<LockCreatedFirstTruncateErrorReleaseSucceededCompletionV1> {
    match value {
        ReachabilityV1::Reached(LockCompletionV1::UnsafeRetentionSucceededThenRouteUnknown) => {
            Some(LockCreatedFirstTruncateErrorReleaseSucceededCompletionV1::RetentionSucceeded)
        }
        ReachabilityV1::Reached(LockCompletionV1::UnsafeRetentionRouteUnknownThenRouteUnknown) => {
            Some(LockCreatedFirstTruncateErrorReleaseSucceededCompletionV1::RetentionRouteUnknown)
        }
        _ => None,
    }
}
