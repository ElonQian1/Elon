...
assert.equal(coffee.open_commerce_merchant_id, 'merchant-cofficethinking')
assert.equal(retail.open_commerce_merchant_id, null)
assert.equal(coffee.onboarding_mode, 'existing_project')
assert.equal(retail.onboarding_mode, 'new_project')
...
assert.equal(commerceReadiness.merchant_selection.status, 'selected_binding')
