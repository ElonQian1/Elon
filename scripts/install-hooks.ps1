# 启用本仓库的 git 守门 hooks（pre-push: locked cargo-dev check + 版本号 + 拦截未 add 的 .rs）
...
Write-Host "   pre-push 守门已激活：locked cargo-dev check + Android/后端版本号 + 拦截未 add 的 .rs" -ForegroundColor Gray
