...
| Independent native file library | Root/folder/search/cursor browsing, cache, downloads, rename/soft-delete and existing-file composer association | Targeted protocol/native tests; device pending | Source-only; [browser](chatgpt-private-library-browser.md), [mutations](chatgpt-private-library-mutations.md), [attachment scope](chatgpt-private-library-attachment.md); folders and special sources remain open |
