...
| Offer 本人草稿控制面 | HTTP/MCP 已可在本人 active、具备路由与 verified 证据的 Provider/Pool 下创建、读取、列出和精确撤销 draft Offer；固定版本、状态、绑定和摘要，不产生 Price Snapshot、候选暴露、容量预留或资金动作，状态为 `implementation_uncompiled` |
