...
| Sui 离线预检适配器 / 一次性显示机器凭据 / 摘要匹配 / 追加式报告 | `docs/decisions/sui-offline-preflight-adapters-v1.md`、`server/src/task_settlement/sui_preflight_*.rs`、`server/src/store/task_sui_preflight_*.rs`、`pc-frontend/src/features/open-commerce/SuiPreflightAdaptersPanel.tsx` |
