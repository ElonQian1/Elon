...
| 消费者可携带数据包 V3 / 低敏偏好、披露与账户级调用凭证 / V1、V2 摘要兼容 / 外部包完整性验证与隔离导入 | `docs/decisions/open-commerce-consumer-portability-exports-v3.md`、`docs/decisions/open-commerce-consumer-portability-imports-v1.md`、`server/src/open_commerce_portability_*.rs`、`server/src/store/open_commerce_consumer_portability*.rs`、`pc-frontend/src/features/open-commerce/ConsumerPortabilityExports.tsx`、`ConsumerPortabilityImports.tsx` |
