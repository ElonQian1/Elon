...
| 消费者可携带数据包 V2 / 低敏偏好与披露导出 / V1 摘要兼容 | `docs/decisions/open-commerce-consumer-portability-exports-v2.md`、`server/src/open_commerce_portability_*.rs`、`server/src/store/open_commerce_consumer_portability.rs`、`pc-frontend/src/features/open-commerce/ConsumerPortabilityExports.tsx` |
