...
| 多端后台微调画布 | 🔴 高 | `src/features/ui-tuner/headless-design/` | 🟡 已接入项目级 Web/PWA/Tauri/Android designSession、持久浏览器控制、Tauri 分层证据、验证矩阵和右侧默认 AI 对话；代码尚未编译或平台运行验收，安装节点仍待升级到 MCP schema v1.7 |
