...
function Invoke-Fb2RefreshSelfTest {
    ...
    try {
        ...
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].embedding_transaction_preflight_report_version -eq "fb2_p4_embedding_transaction_preflight_v1") "planned p4 embedding transaction preflight report"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].embedding_transaction_preflight_status -eq "transaction_preflight_available_no_writes") "planned p4 embedding transaction preflight status"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].embedding_transaction_preflight_planned_entry_count -eq "reported_by_fb2_embedding_transaction_preflight_runtime") "planned p4 embedding transaction planned entries delegated"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].embedding_transaction_preflight_skipped_source_count -eq "reported_by_fb2_embedding_transaction_preflight_runtime") "planned p4 embedding transaction skipped sources delegated"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].embedding_transaction_preflight_blocking_reasons -eq "reported_by_fb2_embedding_transaction_preflight_runtime") "planned p4 embedding transaction blocking reasons delegated"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].embedding_text_fixture_report_version -eq "fb2_p4_embedding_text_fixture_v1") "planned p4 embedding text fixture report"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].embedding_text_fixture_status -eq "embedding_text_fixture_materialized_no_writes") "planned p4 embedding text fixture status"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].embedding_text_fixture_materialized_count -eq "reported_by_fb2_embedding_text_fixture_runtime") "planned p4 embedding text fixture materialized count delegated"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].embedding_text_fixture_missing_source_count -eq "reported_by_fb2_embedding_text_fixture_runtime") "planned p4 embedding text fixture missing source count delegated"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].embedding_text_fixture_content_hash_algorithm -eq "sha256_utf8_normalized_text_v1") "planned p4 embedding text fixture hash algorithm"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].embedding_text_fixture_sanitization_policy -eq "fb2_p4_embedding_text_sanitization_v1") "planned p4 embedding text fixture sanitization policy"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].embedding_provider_migration_plan_report_version -eq "fb2_p4_embedding_provider_migration_plan_v1") "planned p4 provider migration report"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].embedding_provider_migration_plan_status -eq "provider_migration_plan_available_no_writes") "planned p4 provider migration no-write status"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].embedding_provider_policy_version -eq "fb2_p4_embedding_provider_policy_v1") "planned p4 provider policy version"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].embedding_provider_selection_state -eq "not_selected_no_provider_calls") "planned p4 provider not selected"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].embedding_provider_model_alias -eq "fb2-context-embedding-planned") "planned p4 provider model alias"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].embedding_vector_migration_plan_version -eq "fb2_p4_vector_migration_plan_v1") "planned p4 vector migration plan"
        Assert-Fb2RefreshSelfTest ([int]$plannedCapability[0].embedding_provider_planned_table_count -eq 4) "planned p4 vector migration table count"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].embedding_write_execution_plan_version -eq "fb2_p4_embedding_write_execution_plan_v1") "planned p4 embedding write execution plan"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].disabled_embedding_skeleton_report_version -eq "fb2_p4_disabled_embedding_skeleton_v1") "planned p4 disabled embedding skeleton report"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].provider_write_implementation_shape_report_version -eq "fb2_p4_provider_write_implementation_shape_v1") "planned p4 provider write implementation shape report"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].disabled_adapter_write_store_report_version -eq "fb2_p4_disabled_adapter_write_store_v1") "planned p4 disabled adapter write store report"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].runtime_approval_checklist_report_version -eq "fb2_p4_runtime_approval_checklist_v1") "planned p4 runtime approval checklist report"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].migration_approval_packet_report_version -eq "fb2_p4_migration_approval_packet_v1") "planned p4 migration approval packet report"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].post_migration_verification_plan_report_version -eq "fb2_p4_post_migration_verification_plan_v1") "planned p4 post-migration verification plan report"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].requirement_traceability_report_version -eq "fb2_ai_context_requirement_traceability_v1") "planned p4 requirement traceability report"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].answer_handoff_report_version -eq "main_project_answer_handoff_markdown") "planned p4 answer handoff report"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].p4_blocker_phase_matrix_version -eq "p4_blocker_phase_matrix") "planned p4 blocker phase matrix"
        Assert-Fb2RefreshSelfTest ([bool]$plannedCapability[0].p4_phase_approvals_all_false) "planned p4 phase approvals all false"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].business_context_status -eq "business_context_requirements_traceable_final_goal_still_open") "planned p4 business context status"
        Assert-Fb2RefreshSelfTest ([bool]$plannedCapability[0].business_data_requirements_traceable) "planned p4 business data requirements traceable"
        Assert-Fb2RefreshSelfTest (-not [bool]$plannedCapability[0].full_original_goal_complete) "planned p4 full original goal not complete"
        Assert-Fb2RefreshSelfTest ([string]$plannedCapability[0].final_completion_blocker -eq "p4_vector_rag_planned_not_approved_or_enabled") "planned p4 final completion blocker"
        Assert-Fb2RefreshSelfTest (-not [bool]$plannedCapability[0].p4_approval_granted) "planned p4 approval not granted"
        Assert-Fb2RefreshSelfTest (-not [bool]$plannedCapability[0].p4_executable_now) "planned p4 not executable now"
        ...
        Assert-Fb2RefreshSelfTest (-not [bool]$plannedCapability[0].persists_transaction_rows) "planned p4 transaction rows not persisted"
        Assert-Fb2RefreshSelfTest (-not [bool]$plannedCapability[0].creates_or_migrates_tables) "planned p4 tables not created or migrated"
        Assert-Fb2RefreshSelfTest (-not [bool]$plannedCapability[0].executes_migration_ddl) "planned p4 migration ddl not executed"
        Assert-Fb2RefreshSelfTest (-not [bool]$plannedCapability[0].calls_embedding_provider) "planned p4 embedding provider not called"
        Assert-Fb2RefreshSelfTest (-not [bool]$plannedCapability[0].provider_secret_required_now) "planned p4 provider secret not required now"
        Assert-Fb2RefreshSelfTest (-not [bool]$plannedCapability[0].provider_secret_printed) "planned p4 provider secret not printed"
        ...
        Assert-Fb2RefreshSelfTest ([bool]$plannedCapability[0].embedding_text_included) "planned p4 sanitized embedding text fixture included"
        Assert-Fb2RefreshSelfTest ([bool]$plannedCapability[0].embedding_text_is_sanitized) "planned p4 embedding text sanitized"
        Assert-Fb2RefreshSelfTest ([bool]$plannedCapability[0].content_hash_computed) "planned p4 content hash computed"
        Assert-Fb2RefreshSelfTest (-not [bool]$plannedCapability[0].persists_fixture_rows) "planned p4 fixture rows not persisted"
        Assert-Fb2RefreshSelfTest (-not [bool]$plannedCapability[0].provider_model_id_selected) "planned p4 provider model id not selected"
        Assert-Fb2RefreshSelfTest (-not [bool]$plannedCapability[0].vector_dimension_locked) "planned p4 vector dimension not locked"
        Assert-Fb2RefreshSelfTest (-not [bool]$plannedCapability[0].ready_to_call_embedding_provider) "planned p4 provider not callable"
        Assert-Fb2RefreshSelfTest (-not [bool]$plannedCapability[0].ready_to_execute_embedding_transaction) "planned p4 embedding transaction not executable"
        Assert-Fb2RefreshSelfTest (-not [bool]$plannedCapability[0].ready_to_execute_migrations) "planned p4 migrations not executable"
