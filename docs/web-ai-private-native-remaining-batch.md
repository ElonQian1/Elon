...
| Model/effort/tool combinations | Reuse 1625/1627 models, new/temporary chat and 1628 Image/Search selection [evidence](reports/chatgpt-composer-state-20260910.md). Study/Canvas reuse the private controller in [published 1671](reports/chatgpt-study-canvas-tools-20260911.md); offline checks pass | 1671 device install/acceptance deferred: wireless offline. Other contexts, preference persistence and full Canvas editing remain unclaimed |
