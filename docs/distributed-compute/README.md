...
| 外部算力池适配器与统一报价 | V273源码/迁移21/21但production runtime未运行；V274/V277/V278 private源码均为`source_written/source_review_only/implementation_uncompiled/implementation_unrun`、0/0。V278含1张77列immutable renewal表/0 view/0 revocation、4 UDF、renewal 11 INSERT+1 CAS与outbound 2 INSERT+1 CAS。#13-#18仍deny，Provider=`registering`、`eligible_rows=0`；sealed ingress无production validator/Runner caller。V280仅冻结纵切架构与market-profile schema ABI，初始profile inventory未选择、admission physical ABI未冻结、实现unwired/uncompiled/unrun 0/0，无源码/migration/fence开放。见[`V280 vertical`](external-pool-service-managed-admission-runner-authority.md)、[`profile ABI`](external-pool-service-managed-market-profile-authority.md)、[`V278`](external-pool-adapter-route-renewal-reachability-authority.md)与[`当前状态`](current-implementation-status.md) |
