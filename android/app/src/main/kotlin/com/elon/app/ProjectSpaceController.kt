...
internal class ProjectSpaceController(
    ...
    fun resumeIfActive() {
        ...
        if (activeChannel != null || activeMemberConversation != null) startPolling() else if (activeSpace != null) { renderProjectSpaceLanding(); refreshCurrentProjectSpace() }
    }
    ...
    private fun syncProjectSpaceAiMenuStyle() {
        binding.projectSpaceAiMenu.setBackgroundResource(R.drawable.bg_project_space_ai_menu_item)
        val iconColor = activity.getColor(R.color.elon_button_primary_text)
    ...
    private companion object {
        ...
        const val PROJECT_SPACE_AI_EXPANDED_WIDTH_DP = 128
