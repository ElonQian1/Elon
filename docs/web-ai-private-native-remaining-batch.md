...
Current implementation audit: 2026-09-11. This is a work list, not a declaration
...
| Personal sharing/list/revoke and deletion | Prior personal cases reused, including [1644 native Copy/revoke](reports/chatgpt-private-acceptance-1644.md). [Canvas list/Copy/revoke](reports/chatgpt-canvas-shared-links-20260911.md) added to the same owner/menu | Canvas device acceptance pending; large-account controls, workspace/post/bulk and server pagination remain. [Contract](chatgpt-private-shared-links.md) |
...
| Model/effort/tool combinations | Reuse accepted models, new/temporary chat and Image/Search [evidence](reports/chatgpt-composer-state-20260910.md). [Study/Canvas 1671](reports/chatgpt-study-canvas-tools-20260911.md) installed on reconnected Xiaomi | Study native selection failed: private catalogue had only Search/Image; zero sends, original state restored. Canvas untested. Live admission cause, other contexts, preference persistence and full Canvas editing remain |
