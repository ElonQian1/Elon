...
[Existing ordinary project plain text](chatgpt-fresh-project-text-dispatch.md): native independent pass on 1753, default published on 1754; reuse. Broader scopes remain separate.
...
| Text submit/stream/stop/follow-up | Independent HTTP: personal existing/new plain text, existing Search/Image, existing local TXT/PDF/PNG with prompt and existing ordinary project plain text are accepted/default-enabled through 1754; no-usable-composer first send passed on adapter 411. Reuse [Stop/follow-up 1699](reports/chatgpt-command-recovery-1698.md#stopped-turn-follow-up-on-1699), [runtime retry 1644](reports/chatgpt-regeneration-store-20260911.md#normal-1644-acceptance) and [independent plain-text retry 1726/1728](chatgpt-fresh-regeneration.md) | Retry outside personal plain text, pre-answer Stop, combined new/tool/file/project/temporary scopes, cold-bootstrap and network-loss recovery remain |
