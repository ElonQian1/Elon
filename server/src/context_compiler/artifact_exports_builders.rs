...
pub(super) fn build_repo_map_markdown(index: &RepoContextIndex) -> String {
...
pub(super) fn build_summaries_markdown(index: &RepoContextIndex) -> String {
    let mut out = String::new();
...
pub(super) fn build_project_manifests_markdown(report: &ProjectManifestReport) -> String {
    let mut out = String::new();
...
pub(super) fn build_directory_summaries_markdown(summaries: &[DirectorySummary]) -> String {
    let mut out = String::new();
...
pub(super) fn build_directories_jsonl(summaries: &[DirectorySummary]) -> String {
    summaries
        .iter()
...
pub(super) fn build_symbols_jsonl(index: &RepoContextIndex) -> String {
    index
        .rust
        .symbols
        .iter()
...
pub(super) fn build_symbol_index_jsonl(index: &SymbolIndex) -> String {
    index
        .records
        .iter()
...
pub(super) fn build_symbol_edges_jsonl(index: &SymbolIndex) -> String {
    index
        .edges
        .iter()
...
pub(super) fn build_symbol_lookup_json(index: &SymbolIndex) -> String {
    serde_json::to_string_pretty(&index.lookup_summary()).unwrap_or_else(|_| "{}".to_string())
        + "\n"
}

pub(super) fn build_edges_tsv(index: &RepoContextIndex) -> String {
    let mut out = String::new();
...
pub(super) fn build_chunks_jsonl(index: &RepoContextIndex) -> String {
    index
        .evidence
        .snippets
        .iter()
...
pub(super) fn build_lsp_locations_jsonl(index: &RepoContextIndex) -> String {
    let mut lines = Vec::new();
...
pub(super) fn build_semantic_facts_jsonl(index: &RepoContextIndex) -> String {
    index
        .rust_analyzer
        .lsp
        .results
...
pub(super) fn semantic_fact_kind(method: SemanticQueryMethod) -> &'static str {
    match method {
...
pub(super) fn push_list(out: &mut String, label: &str, values: &[String]) {
    if values.is_empty() {
...
pub(super) fn markdown_table_escape(value: &str) -> String {
