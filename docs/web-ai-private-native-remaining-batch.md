...
| Personal sharing/list/revoke and deletion | Reuse [1644](reports/chatgpt-private-acceptance-1644.md), [Canvas 1673](reports/chatgpt-canvas-shared-links-20260911.md). [1675](reports/chatgpt-canvas-production-1675-20260912.md) published editor/history/share; entry/empty list passed | Fixture missing; viewer interrupted. Editor/writes, disposable revoke, workspace/post/bulk and pagination pending |
