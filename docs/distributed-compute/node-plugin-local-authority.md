...
这仍不是生产 planning context：A1 未专项运行；A2 targeted 5 项通过，Barrier/RegistrationShutdown/RegistryLifecycle/Unmap/JointClose 分别为 `8/8`、`8/8`、`16/16`、`49/49`、`36/36`，A2b2=`117/117`、wide=`266/266`。Map/Lock denominator 未开放，A2 未动态验收，见[`A2验收`](node-plugin-vfs-fault-acceptance.md)。生产 open/VFS/process/root/time/rollback/producer 仍不可达；v14 blocked-only，无 Host/PlanApply/下载/准入/Ready 副作用。
