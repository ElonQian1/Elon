...
| 服务端动作确认 / 5 分钟凭证 / 本人状态恢复 / 输入与幂等绑定 / 原子一次消费 | `docs/decisions/open-commerce-server-action-confirmation-v1.md`、`server/src/open_commerce_action_confirmation_*.rs`、`server/src/store/open_commerce_action_confirmations.rs`、`docs/open-commerce-server-action-confirmation-v1-acceptance.md` |
...
| 分布式算力共享 CapacityPool / 追加式容量账本 / 跨 Offer 防超卖 / V1 单 Pool 单精确半开窗口 / 已接受但尚未实现 | `docs/decisions/distributed-compute-capacity-ledger-v1.md`、`docs/distributed-compute/capacity-ledger.md`、`docs/distributed-compute/architecture.md`、`docs/distributed-compute/market-and-settlement.md` |
