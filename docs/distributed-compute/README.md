...
| 外部算力池适配器与统一报价 | v221/v222 管理面、v227 bytes source、v229 lifecycle、v230 signer key 和 v231 exact RSA signed provenance 已分别通过本地专项，均为 `implementation_partially_verified`。v231 只证明注册私钥签署 exact admission/source/key/Artifact 绑定；仍缺格式、安全、conformance、verifier、Adapter、v213 route、真实派发和结算。真实崩溃/断电、生产文件边界、TCP、升级、部署及 v227-v231 MCP/PC 也未验收。见 [`external-pool-adapter-artifact-signed-provenance-authority.md`](external-pool-adapter-artifact-signed-provenance-authority.md) 与 [`external-pool-adapter-artifact-signed-provenance-acceptance.md`](external-pool-adapter-artifact-signed-provenance-acceptance.md) |
