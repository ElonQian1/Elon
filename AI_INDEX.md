...
| Web/PWA/Tauri/Android 后台设计会话 / Tauri 原生窗口证据 / 可撤销草稿 / 源码绑定与写回回执 / PC 多端画布和右侧聊天 | `docs/headless-ui-design-mcp.md`、`server/src/node_agent_android_live/design_targets.rs`、`server/src/node_agent_android_live/design_session_store.rs`、`server/src/node_agent_android_live/design_http.rs`、`server/src/node_agent_android_live/design_target_discovery.rs`、`server/src/node_agent_android_live/tauri_host_runtime.rs`、`server/src/node_agent_android_live/tauri_host_windows.rs`、`server/src/node_agent_android_live/design_drafts.rs`、`server/src/node_agent_pwa_runtime/semantic_tree.rs`、`server/src/node_agent_source_preview/writeback_receipt.rs`、`server/src/node_agent_source_preview/writeback_receipt_workspace.rs`、`pc-frontend/src/features/ui-tuner/headless-design/`、`server/src/node_agent_android_live/design_targets_tests.rs` |
...
| 消费者发现 / 第三方应用沙盒 / 一次性测试 Token / 授权审批与 Grant 总预算 | `docs/open-commerce/consumer-developer-sandbox.md`、`docs/decisions/open-commerce-grant-budgets-v1.md`、`server/src/open_commerce_client_*.rs`、`server/src/open_commerce_grant_budget_*.rs`、`pc-frontend/src/features/open-commerce/ConsumerCommerceSandbox.tsx`、`DeveloperCommercePortal.tsx` |
...
| 消费者关联数据删除请求 / 商户完成声明 / 追加式未核验外部证明 | `docs/decisions/open-commerce-consumer-data-erasure-requests-v1.md`、`docs/decisions/open-commerce-consumer-data-erasure-evidence-v1.md`、`server/src/open_commerce_data_request_*.rs`、`server/src/open_commerce_data_erasure_evidence_*.rs`、`server/src/store/open_commerce_data_erasure_evidence.rs`、`pc-frontend/src/features/open-commerce/ConsumerDataRequestManager.tsx`、`MerchantDataRequestInbox.tsx` |
| 消费者可携带数据包 V4 / 商户身份声明 / 隔离导入 / 运营方 RSA 签名 / 低敏偏好字段级采用与回滚 / 本地口令加密归档 / 关系映射与重新授权 | `docs/decisions/open-commerce-consumer-portability-exports-v4.md`、`docs/decisions/open-commerce-consumer-portability-exports-v3.md`、`docs/decisions/open-commerce-consumer-portability-imports-v1.md`、`docs/decisions/open-commerce-consumer-portability-trust-v1.md`、`docs/decisions/open-commerce-consumer-portability-adoption-v1.md`、`docs/decisions/open-commerce-consumer-portability-selective-adoption-v1.md`、`docs/decisions/open-commerce-consumer-portability-encrypted-archives-v1.md`、`docs/decisions/open-commerce-consumer-portability-reauthorization-v1.md`、`server/src/open_commerce_portability_*.rs`、`server/src/store/open_commerce_consumer_portability*.rs`、`server/src/store/open_commerce_portability_reauthorization.rs`、`sdk/open-commerce-connector/src/portability-signature.js`、`portability-archive.js`、`pc-frontend/src/features/open-commerce/ConsumerPortabilityExports.tsx`、`ConsumerPortabilityImports.tsx`、`ConsumerPortabilityTrustKeys.tsx`、`ConsumerPortabilityAdoptions.tsx`、`ConsumerPortabilityReauthorization.tsx`、`portabilityArchive.ts` |
