...
| Web/PWA/Tauri/Android 后台设计会话 / 持久浏览器、安全 fixture 与可恢复草稿预览 / UI tree 到源码绑定候选 / Tauri 分层证据 / 写回与验证矩阵 / PC 画布自动跟随和右侧聊天 | `docs/headless-ui-design-mcp.md`、`server/src/node_agent_android_live/design_targets.rs`、`server/src/node_agent_android_live/design_browser_runtime.rs`、`server/src/node_agent_android_live/design_draft_preview.rs`、`server/src/node_agent_android_live/design_source_binding.rs`、`server/src/node_agent_android_live/design_verification_matrix.rs`、`server/src/node_agent_android_live/tauri_host_runtime.rs`、`server/src/node_agent_android_live/tauri_behavior.rs`、`server/src/node_agent_android_live/design_drafts.rs`、`server/src/node_agent_pwa_runtime/stateful.rs`、`server/src/node_agent_pwa_runtime/style_preview.rs`、`server/src/node_agent_source_preview/writeback_receipt.rs`、`pc-frontend/src/features/ui-tuner/headless-design/` |
...
| 消费者发现 / 用户选择透明非付费排序器 / 商户声明来源与新鲜度 / 内部同步回执来源绑定及消费者筛选 / 消费者声明期筛选 / 可复核未签名单次排序凭证 / 第三方应用沙盒 / 一次性测试 Token / 授权审批与 Grant 总预算 | `docs/open-commerce/consumer-developer-sandbox.md`、`docs/decisions/open-commerce-pluggable-ranking-v1.md`、`docs/decisions/open-commerce-public-data-provenance-v1.md`、`docs/decisions/open-commerce-capability-source-link-v1.md`、`docs/decisions/open-commerce-consumer-source-requirement-v1.md`、`docs/decisions/open-commerce-consumer-freshness-filter-v1.md`、`docs/decisions/open-commerce-consumer-ranking-receipts-v1.md`、`docs/open-commerce-pluggable-ranking-v1-acceptance.md`、`docs/open-commerce-public-data-provenance-v1-acceptance.md`、`docs/open-commerce-capability-source-link-v1-acceptance.md`、`docs/open-commerce-consumer-source-requirement-v1-acceptance.md`、`docs/open-commerce-consumer-freshness-filter-v1-acceptance.md`、`docs/open-commerce-consumer-ranking-receipts-v1-acceptance.md`、`docs/decisions/open-commerce-grant-budgets-v1.md`、`server/src/open_commerce_capability_source_*.rs`、`server/src/store/open_commerce_capability_sources.rs`、`server/src/open_commerce_directory_model.rs`、`server/src/open_commerce_consumer_ranking.rs`、`server/src/open_commerce_consumer.rs`、`server/src/open_commerce_client_*.rs`、`server/src/open_commerce_grant_budget_*.rs`、`pc-frontend/src/features/open-commerce/consumerRankingReceipt.ts`、`ConsumerCommerceSandbox.tsx`、`DeveloperCommercePortal.tsx` |
