...
| Web/PWA/Tauri/Android 后台设计会话 / 项目恢复 / 语义 UI 树 / PC 多端画布与右侧聊天 | `docs/headless-ui-design-mcp.md`、`server/src/node_agent_android_live/design_targets.rs`、`server/src/node_agent_android_live/design_session_store.rs`、`server/src/node_agent_android_live/design_http.rs`、`server/src/node_agent_android_live/design_target_discovery.rs`、`server/src/node_agent_pwa_runtime/semantic_tree.rs`、`pc-frontend/src/features/ui-tuner/headless-design/`、`server/src/node_agent_android_live/design_targets_tests.rs` |
