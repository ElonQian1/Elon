...
| Personal sharing/list/revoke and deletion | Reuse [1644 Copy/revoke](reports/chatgpt-private-acceptance-1644.md), [Canvas list/Copy/Keep-link 1673](reports/chatgpt-canvas-shared-links-20260911.md). [Native Canvas source viewer](reports/chatgpt-canvas-content-native-20260912.md) implemented, device acceptance pending | Canvas revoke needs a disposable link; edit/publish, workspace/post/bulk and server pagination remain |
