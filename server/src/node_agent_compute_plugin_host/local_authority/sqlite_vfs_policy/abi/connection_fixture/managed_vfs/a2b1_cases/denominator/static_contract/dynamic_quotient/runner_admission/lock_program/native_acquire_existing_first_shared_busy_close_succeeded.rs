//! Exact q19 source programs for existing-first DMS shared-acquire contention after known
...
pub(super) use source_scope::NATIVE_ACQUIRE_EXISTING_FIRST_SHARED_BUSY_CLOSE_SUCCEEDED_PROJECTOR_DELTA_V1;
...
pub(super) const EXISTING_FIRST_SHARED_BUSY_CLOSE_SUCCEEDED_MEMBER_COUNT: usize = 88;

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(super) enum LockExistingFirstSharedBusyCloseSucceededCompletionV1 {
    RetentionSucceeded,
    RetentionRouteUnknown,
}

impl LockExistingFirstSharedBusyCloseSucceededCompletionV1 {
...
#[derive(Clone, Copy)]
pub(super) struct LockNativeAcquireExistingFirstSharedBusyCloseSucceededProgramSpecV1 {
    #[cfg(windows)]
    ...
    pub(super) mask: u8,
    #[cfg(windows)]
    pub(super) completion: LockExistingFirstSharedBusyCloseSucceededCompletionV1,
...
) -> Option<LockExistingFirstSharedBusyCloseSucceededCompletionV1> {
    match value {
        ReachabilityV1::Reached(LockCompletionV1::UnsafeRetentionSucceededThenRouteUnknown) => {
            Some(LockExistingFirstSharedBusyCloseSucceededCompletionV1::RetentionSucceeded)
        }
        ReachabilityV1::Reached(LockCompletionV1::UnsafeRetentionRouteUnknownThenRouteUnknown) => {
            Some(LockExistingFirstSharedBusyCloseSucceededCompletionV1::RetentionRouteUnknown)
        }
        _ => None,
    }
}
...
fn expected_axes_v1(
    ...
    count: u8,
    mask: u8,
    completion: LockExistingFirstSharedBusyCloseSucceededCompletionV1,
) -> LockAxesV1 {
    LockAxesV1 {
