...
function New-Fb2ContextFormatRouteValidation {
    ...
    Add-Fb2FormatCheck $checks `
        ...
        (Test-Fb2FormatAllTokens $texts.readme @("bfed1cc8", "73a40385", "92bd93c1", "a555efd7", "fb2_p4_vector_readiness_plan_v1", "fb2_p4_vector_contract_v1", "fb2_p4_source_enumerator_v1", "fb2_p4_chunk_manifest_v1", "fb2_p4_embedding_build_dry_run_v1", "fb2_p4_embedding_transaction_preflight_v1", "fb2_p4_embedding_text_fixture_v1", "fb2_p4_embedding_provider_migration_plan_v1", "fb2_p4_disabled_embedding_skeleton_v1", "fb2_p4_provider_write_implementation_shape_v1", "fb2_p4_disabled_adapter_write_store_v1", "fb2_p4_runtime_approval_checklist_v1", "fb2_p4_migration_approval_packet_v1", "fb2_p4_post_migration_verification_plan_v1", "fb2_ai_context_requirement_traceability_v1", "main_project_answer_handoff_markdown", "p4_blocker_phase_matrix", "p4_phase_approvals_all_false", "business_context_requirements_traceable_final_goal_still_open", "business_data_requirements_traceable=true", "full_original_goal_complete=false", "p4_vector_rag_planned_not_approved_or_enabled", "approval_granted=false", "executable_now=false", "source_specific_no_write_sample_available", "id_only_no_write_manifest_available", "not_checked_missing_current_user_scope", "not_checked_missing_platform_scope", "contract_design_committed_embedding_not_started", "dry_run_available_no_writes", "transaction_preflight_available_no_writes", "embedding_text_fixture_materialized_no_writes", "provider_migration_plan_available_no_writes", "fb2_p4_embedding_provider_policy_v1", "not_selected_no_provider_calls", "fb2_p4_vector_migration_plan_v1", "fb2_p4_embedding_write_execution_plan_v1", "fb2_p4_embedding_text_sanitization_v1", "sha256_utf8_normalized_text_v1", "production_grounding=false", "answer_time_vector_candidates_enabled=false", "writes_chunk_manifest_file=false", "persists_manifest_rows=false", "persists_transaction_rows=false", "persists_fixture_rows=false", "creates_or_migrates_tables=false", "executes_migration_ddl=false", "calls_embedding_provider=false", "provider_secret_required_now=false", "provider_secret_printed=false", "provider_model_id_selected=false", "vector_dimension_locked=false", "ready_to_call_embedding_provider=false", "source_payload_included=false", "embedding_text_included=true", "embedding_text_is_sanitized=true", "content_hash_computed=true", "writes_embedding_rows=false", "writes_vector_store=false", "writes_public_group_messages=false", "ready_to_execute_embedding_transaction=false", "ready_to_execute_migrations=false", "ready_to_write_embeddings=false", "ready_for_shadow_eval=false", "refresh_operations_used=false", "candidate_rows_require_live_hydration=true", "vector_rows_are_model_input=false", "does_not_enable_vector=true", "ready_to_build_embedding_store=false", "ready_to_enable_answer_time_vector_candidates=false", "生产 grounding")) `
        $files.readme `
    ...
    Add-Fb2FormatCheck $checks `
        ...
        (Test-Fb2FormatAllTokens $texts.handoff @("bfed1cc8", "73a40385", "92bd93c1", "a555efd7", "fb2_p4_vector_readiness_plan_v1", "fb2_p4_vector_contract_v1", "fb2_p4_source_enumerator_v1", "fb2_p4_chunk_manifest_v1", "fb2_p4_embedding_build_dry_run_v1", "fb2_p4_embedding_transaction_preflight_v1", "fb2_p4_embedding_text_fixture_v1", "fb2_p4_embedding_provider_migration_plan_v1", "fb2_p4_disabled_embedding_skeleton_v1", "fb2_p4_provider_write_implementation_shape_v1", "fb2_p4_disabled_adapter_write_store_v1", "fb2_p4_runtime_approval_checklist_v1", "fb2_p4_migration_approval_packet_v1", "fb2_p4_post_migration_verification_plan_v1", "fb2_ai_context_requirement_traceability_v1", "main_project_answer_handoff_markdown", "p4_blocker_phase_matrix", "p4_phase_approvals_all_false", "business_context_requirements_traceable_final_goal_still_open", "business_data_requirements_traceable=true", "full_original_goal_complete=false", "p4_vector_rag_planned_not_approved_or_enabled", "approval_granted=false", "executable_now=false", "source_specific_no_write_sample_available", "id_only_no_write_manifest_available", "not_checked_missing_current_user_scope", "not_checked_missing_platform_scope", "contract_design_committed_embedding_not_started", "dry_run_available_no_writes", "transaction_preflight_available_no_writes", "embedding_text_fixture_materialized_no_writes", "provider_migration_plan_available_no_writes", "fb2_p4_embedding_provider_policy_v1", "not_selected_no_provider_calls", "fb2_p4_vector_migration_plan_v1", "fb2_p4_embedding_write_execution_plan_v1", "fb2_p4_embedding_text_sanitization_v1", "sha256_utf8_normalized_text_v1", "p4_vector_readiness_status=planned", "production_grounding=false", "blocks_data_goal=false", "answer_time_vector_candidates_enabled=false", "writes_chunk_manifest_file=false", "persists_manifest_rows=false", "persists_transaction_rows=false", "persists_fixture_rows=false", "creates_or_migrates_tables=false", "executes_migration_ddl=false", "calls_embedding_provider=false", "provider_secret_required_now=false", "provider_secret_printed=false", "provider_model_id_selected=false", "vector_dimension_locked=false", "ready_to_call_embedding_provider=false", "source_payload_included=false", "embedding_text_included=true", "embedding_text_is_sanitized=true", "content_hash_computed=true", "writes_embedding_rows=false", "writes_vector_store=false", "writes_public_group_messages=false", "ready_to_execute_embedding_transaction=false", "ready_to_execute_migrations=false", "ready_to_write_embeddings=false", "ready_for_shadow_eval=false", "refresh_operations_used=false", "candidate_rows_require_live_hydration=true", "vector_rows_are_model_input=false", "does_not_enable_vector=true", "ready_to_build_embedding_store=false", "ready_to_enable_answer_time_vector_candidates=false", "answer-time grounding")) `
        $files.handoff `
    ...
    Add-Fb2FormatCheck $checks `
        ...
        (Test-Fb2FormatAllTokens $texts.test_plan @("bfed1cc8", "fb2_p4_vector_readiness_plan_v1", "fb2_p4_vector_contract_v1", "fb2_p4_source_enumerator_v1", "fb2_p4_chunk_manifest_v1", "fb2_p4_embedding_build_dry_run_v1", "fb2_p4_embedding_transaction_preflight_v1", "fb2_p4_embedding_text_fixture_v1", "fb2_p4_embedding_provider_migration_plan_v1", "fb2_p4_disabled_embedding_skeleton_v1", "fb2_p4_provider_write_implementation_shape_v1", "fb2_p4_disabled_adapter_write_store_v1", "fb2_p4_runtime_approval_checklist_v1", "fb2_p4_migration_approval_packet_v1", "fb2_p4_post_migration_verification_plan_v1", "fb2_ai_context_requirement_traceability_v1", "main_project_answer_handoff_markdown", "p4_blocker_phase_matrix", "p4_phase_approvals_all_false", "business_context_requirements_traceable_final_goal_still_open", "business_data_requirements_traceable=true", "full_original_goal_complete=false", "p4_vector_rag_planned_not_approved_or_enabled", "approval_granted=false", "executable_now=false", "只读计划/契约设计/no-write source enumeration/ID-only no-write manifest/no-write dry-run/no-write transaction preflight/sanitized no-write text fixture/provider migration no-write plan", "不是生产 grounding", "production_grounding=false", "blocks_data_goal=false", "answer_time_vector_candidates_enabled=false", "implemented=false", "dry_run_available_no_writes", "transaction_preflight_available_no_writes", "embedding_text_fixture_materialized_no_writes", "provider_migration_plan_available_no_writes", "fb2_p4_embedding_provider_policy_v1", "not_selected_no_provider_calls", "fb2_p4_vector_migration_plan_v1", "fb2_p4_embedding_write_execution_plan_v1", "id_only_no_write_manifest_available", "not_checked_missing_current_user_scope", "not_checked_missing_platform_scope", "writes_chunk_manifest_file=false", "persists_manifest_rows=false", "persists_transaction_rows=false", "persists_fixture_rows=false", "creates_or_migrates_tables=false", "executes_migration_ddl=false", "calls_embedding_provider=false", "provider_secret_required_now=false", "provider_secret_printed=false", "provider_model_id_selected=false", "vector_dimension_locked=false", "ready_to_call_embedding_provider=false", "source_payload_included=false", "embedding_text_included=true", "embedding_text_is_sanitized=true", "content_hash_computed=true", "writes_embedding_rows=false", "writes_vector_store=false", "writes_public_group_messages=false", "ready_to_execute_embedding_transaction=false", "ready_to_execute_migrations=false", "ready_to_write_embeddings=false", "ready_for_shadow_eval=false", "refresh_operations_used=false", "candidate_rows_require_live_hydration=true", "vector_rows_are_model_input=false", "does_not_enable_vector=true", "ready_to_build_embedding_store=false", "ready_to_enable_answer_time_vector_candidates=false")) `
        $files.test_plan `
...
bfed1cc8 73a40385 92bd93c1 a555efd7 9aa581e1 d0967bb5 b2493cbc e6caccac d93287e9 165e50f2 d4efde21 fb2_p4_vector_readiness_plan_v1 fb2_p4_vector_contract_v1 fb2_p4_source_enumerator_v1 fb2_p4_chunk_manifest_v1 fb2_p4_embedding_build_dry_run_v1 fb2_p4_embedding_transaction_preflight_v1 fb2_p4_embedding_text_fixture_v1 fb2_p4_embedding_provider_migration_plan_v1 fb2_p4_disabled_embedding_skeleton_v1 fb2_p4_provider_write_implementation_shape_v1 fb2_p4_disabled_adapter_write_store_v1 fb2_p4_runtime_approval_checklist_v1 fb2_p4_migration_approval_packet_v1 fb2_p4_post_migration_verification_plan_v1 fb2_ai_context_requirement_traceability_v1 main_project_answer_handoff_markdown p4_blocker_phase_matrix p4_phase_approvals_all_false business_context_requirements_traceable_final_goal_still_open business_data_requirements_traceable=true full_original_goal_complete=false p4_vector_rag_planned_not_approved_or_enabled approval_granted=false executable_now=false source_specific_no_write_sample_available id_only_no_write_manifest_available transaction_preflight_available_no_writes embedding_text_fixture_materialized_no_writes provider_migration_plan_available_no_writes fb2_p4_embedding_provider_policy_v1 not_selected_no_provider_calls fb2_p4_vector_migration_plan_v1 fb2_p4_embedding_write_execution_plan_v1 fb2_p4_embedding_text_sanitization_v1 sha256_utf8_normalized_text_v1 not_checked_missing_current_user_scope not_checked_missing_platform_scope source_enumerator_checked_count source_enumerator_known_chunk_count chunk_manifest_materialized_entry_count chunk_manifest_current_scope_complete embedding_transaction_preflight_planned_entry_count embedding_transaction_preflight_skipped_source_count embedding_transaction_preflight_blocking_reasons embedding_text_fixture_materialized_count embedding_text_fixture_missing_source_count contract_design_committed_embedding_not_started dry_run_available_no_writes p4_vector_readiness_status=planned 只读计划/契约设计/no-write source enumeration/ID-only no-write manifest/no-write dry-run/no-write transaction preflight/sanitized no-write text fixture/provider migration no-write plan 只读计划报告 不是生产 grounding production_grounding=false blocks_data_goal=false answer_time_vector_candidates_enabled=false implemented=false writes_chunk_manifest_file=false persists_manifest_rows=false persists_transaction_rows=false persists_fixture_rows=false creates_or_migrates_tables=false executes_migration_ddl=false calls_embedding_provider=false provider_secret_required_now=false provider_secret_printed=false provider_model_id_selected=false vector_dimension_locked=false ready_to_call_embedding_provider=false source_payload_included=false embedding_text_included=true embedding_text_is_sanitized=true content_hash_computed=true writes_embedding_rows=false writes_vector_store=false writes_public_group_messages=false ready_to_execute_embedding_transaction=false ready_to_execute_migrations=false ready_to_write_embeddings=false ready_for_shadow_eval=false refresh_operations_used=false candidate_rows_require_live_hydration=true vector_rows_are_model_input=false does_not_enable_vector=true ready_to_build_embedding_store=false ready_to_enable_answer_time_vector_candidates=false answer-time grounding 生产 grounding source allowlist chunk schema permission filter SQL offline embedding build hydration shadow eval answer-time readthrough source_enumerations enumerator_status source_dry_runs permission_partitions known_estimated_chunk_count unknown_estimate_source_count
"@
