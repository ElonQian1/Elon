...
pub(crate) static MIGRATIONS: &[(u32, &str, fn(&Connection) -> Result<()>)] = &[
    ...
    (169, "分布式算力提供者版本化注册表", crate::compute_provider_migration::migration_v169),
    ...
    (178, "分布式算力过期激活批准显式废止审计", crate::compute_activation_request_migration::migration_v178),
    ...
    (183, "分布式算力 Offer 追加式生命周期回执", crate::compute_offer_lifecycle_migration::migration_v183),
    (184, "分布式算力 Offer 终态依赖查询索引", crate::compute_offer_terminal_migration::migration_v184),
    ...
    (189, "分布式算力 Attempt Provider 终态候选", crate::compute_attempt_terminal_migration::migration_v189),
    (190, "分布式算力 Attempt 消费者终态审核证据", crate::compute_attempt_consumer_review_migration::migration_v190),
    (191, "分布式算力 Attempt 平台终态观测证据", crate::compute_attempt_platform_observation_migration::migration_v191),
    (192, "分布式算力 Attempt Verification 决定", crate::compute_attempt_verification_migration::migration_v192),
    ...
    (197, "分布式算力 Attempt 结算挑战终态决议", crate::compute_settlement_challenge_resolution_migration::migration_v197),
    (198, "分布式算力 Attempt 待结算原子释放", crate::compute_settlement_release_migration::migration_v198),
    (199, "分布式算力 Attempt accepted 挑战原子纠正", crate::compute_settlement_correction_migration::migration_v199),
    (200, "分布式算力 Provider available 提现申请冻结", crate::compute_settlement_withdrawal_request_migration::migration_v200),
    (201, "分布式算力 Provider 提现唯一终态", crate::compute_settlement_withdrawal_terminal_migration::migration_v201),
    (202, "分布式算力到期释放批次意图与完成回执", crate::compute_settlement_release_batch_migration::migration_v202),
    (203, "分布式算力激活计划双人复核回执", crate::compute_activation_plan_review_migration::migration_v203),
