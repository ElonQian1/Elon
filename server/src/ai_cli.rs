...
{"type":"item.completed","item":{"type":"agent_message","text":"hello"}}"#;
    ...
    fn development_prompt_keeps_project_workflow() {
        ...
        assert!(prompt.contains("git pull --ff-only origin main"));
    }
