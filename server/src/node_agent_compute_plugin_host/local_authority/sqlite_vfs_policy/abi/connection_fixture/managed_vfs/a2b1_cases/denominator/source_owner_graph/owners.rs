...
pub(super) const SOURCE_BASELINE_COMMIT: &str = "e23be4b4509039b8457f4e1c0c698c93a502bdbb";
...
pub(super) const OWNERS: &[OwnerSnapshot] = &[
    ...
    owner(SourceOwnerId::ManagedNamespace, "src/node_agent_managed_fs/sqlite_namespace.rs", "3e969ca0d3ee1da711950dc9f4ff5dd939c95a59", "798abd34e6bdd5fd9fc90dff06b496e785499f60efcd5b7fb5033ea3e679ae98", &["fn open_exact"]),
    ...
    owner(SourceOwnerId::ManagedShmRoot, "src/node_agent_managed_fs/sqlite_namespace_shm.rs", "38418abbc89bac3aa51c30a345a349d31de52de0", "8ccf48a4fd2ed0a26998ae137cae9de4a2c1c3923b02ef5fbe3774c88f9d53dc", &["fn open_shm_for_wal", "#[path = \"windows_sqlite_shm.rs\"]"]),
    owner(SourceOwnerId::ManagedCoordinator, "src/node_agent_managed_fs/sqlite_namespace_shm/coordinator.rs", "bb8afdef1a8b1b8c7d78f7944247752f14ce3778", "e0d6111f7e8fba3c19ea536401711a59928e1262cf8dcb2636e8fbb082ee3df4", &["fn bind_main_file", "fn attach", "fn poisoned_failure", "fn mark_poisoned"]),
    ...
    owner(SourceOwnerId::ManagedFaultApi, "src/node_agent_managed_fs/sqlite_namespace_shm/test_faults/api.rs", "2a4ec3cee887bb65d45c5729a7be45a22836dcf6", "a74ac16223935a949039991aee7207557aa61a9e46084fa9c2bd553ead635364", &["fn observe_test_fault", "fn trigger_before_test_fault", "fn trigger_after_test_fault", "fn install_shm_test_fault_script"]),
