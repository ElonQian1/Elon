...
| Personal sharing/list/revoke and deletion | Reuse [1644 Copy/revoke](reports/chatgpt-private-acceptance-1644.md). [Canvas native list/Copy/keep-link passed on 1673](reports/chatgpt-canvas-shared-links-20260911.md#native-list-copy-and-keep-link-acceptance) | Canvas revoke needs a disposable link; workspace/post/bulk and server pagination remain. [Contract](chatgpt-private-shared-links.md) |
