...
| Fresh independent text dispatch | ChatGPT | Completed/default-enabled for existing personal plain text on 1696: native first/follow-up, handed-off reply, stop and default routing accepted. Lifetime receipts/stopped-parent follow-on is source-tested, grouped acceptance pending | Accepted sender only before dispatch; uncertain writes never replay. New/tool/file/project/temporary and initial composer-free scopes remain. [Evidence](chatgpt-fresh-text-dispatch.md) |
