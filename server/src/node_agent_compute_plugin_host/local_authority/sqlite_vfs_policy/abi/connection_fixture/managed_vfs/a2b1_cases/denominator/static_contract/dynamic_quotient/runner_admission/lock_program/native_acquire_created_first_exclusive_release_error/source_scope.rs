//! Source closure and implementation seals for the q12 initialization-release tranche.
...
/// New source identities introduced by q12. Modified shared roots remain in the inherited closure.
pub(super) const NATIVE_ACQUIRE_CREATED_FIRST_EXCLUSIVE_RELEASE_ERROR_PROJECTOR_DELTA_V1: &[(&str, &str)] = &[
    (
        "dynamic_quotient/runner_admission/lock_program/native_acquire_created_first_exclusive_release_error.rs",
        include_str!("../native_acquire_created_first_exclusive_release_error.rs"),
    ),
    (
    ...
    (
        ...
        include_str!("native_acquire_created_first_exclusive_release_error_members.v1.tsv"),
    ),
    source!(
        "managed_vfs/connection/lock_initialization.rs",
        "/src/node_agent_compute_plugin_host/local_authority/sqlite_vfs_policy/abi/connection_fixture/managed_vfs/connection/lock_initialization.rs"
    ),
    source!(
        "managed_vfs/a2_dynamic_evidence/child/lock_created_first_exclusive_release_error.rs",
        "/src/node_agent_compute_plugin_host/local_authority/sqlite_vfs_policy/abi/connection_fixture/managed_vfs/a2_dynamic_evidence/child/lock_created_first_exclusive_release_error.rs"
    ),
    source!(
        "managed_vfs/a2_dynamic_evidence/lock_runner/created_first_exclusive_release_error.rs",
        "/src/node_agent_compute_plugin_host/local_authority/sqlite_vfs_policy/abi/connection_fixture/managed_vfs/a2_dynamic_evidence/lock_runner/created_first_exclusive_release_error.rs"
    ),
    source!(
        "managed_vfs/a2_dynamic_evidence/lock_runner/created_first_exclusive_release_error/fixture.rs",
        "/src/node_agent_compute_plugin_host/local_authority/sqlite_vfs_policy/abi/connection_fixture/managed_vfs/a2_dynamic_evidence/lock_runner/created_first_exclusive_release_error/fixture.rs"
    ),
    source!(
        "managed_vfs/a2_dynamic_evidence/lock_runner/created_first_exclusive_release_error/payload.rs",
        "/src/node_agent_compute_plugin_host/local_authority/sqlite_vfs_policy/abi/connection_fixture/managed_vfs/a2_dynamic_evidence/lock_runner/created_first_exclusive_release_error/payload.rs"
    ),
    source!(
        "node_agent_managed_fs/sqlite_namespace_shm/test_initialization_runtime.rs",
        "/src/node_agent_managed_fs/sqlite_namespace_shm/test_initialization_runtime.rs"
    ),
    source!(
        "node_agent_managed_fs/sqlite_namespace_shm/test_initialization_runtime/controller.rs",
        "/src/node_agent_managed_fs/sqlite_namespace_shm/test_initialization_runtime/controller.rs"
    ),
    source!(
        "node_agent_managed_fs/sqlite_namespace_shm/test_initialization_runtime/model.rs",
        "/src/node_agent_managed_fs/sqlite_namespace_shm/test_initialization_runtime/model.rs"
    ),
    source!(
        "node_agent_managed_fs/sqlite_namespace_shm/test_initialization_runtime/tests.rs",
        "/src/node_agent_managed_fs/sqlite_namespace_shm/test_initialization_runtime/tests.rs"
    ),
];
...
pub(super) fn digest_implementation_v1(
    ...
    hasher.update(
        b"elon-lock-native-acquire-created-first-exclusive-release-error-implementation-v1\0",
    );
    // q9 repeated one shared dispatch identity already owned by the inherited q1-q8 closure.
