...
| 外部算力池适配器与统一报价 | V273源码/迁移21/21但production runtime未运行；V274/V277/V278 private源码均为`source_written/source_review_only/implementation_uncompiled/implementation_unrun`、0/0。#13-#18仍deny，Provider=`registering`、`eligible_rows=0`；sealed ingress无production validator/Runner caller。V280已冻结纵切架构、market-profile schema与planned 77列admission receipt ABI，但初始inventory未选择、market projection identity未冻结，table/migration/source仍absent，整体unwired/uncompiled/unrun 0/0。见[`V280 vertical`](external-pool-service-managed-admission-runner-authority.md)、[`profile ABI`](external-pool-service-managed-market-profile-authority.md)、[`admission ABI`](external-pool-service-managed-admission-receipt-abi-authority.md)、[`V278`](external-pool-adapter-route-renewal-reachability-authority.md)与[`当前状态`](current-implementation-status.md) |
