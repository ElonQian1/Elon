//! Exact q15 source programs for existing-first DMS truncate failure with successful exclusive release.
//!
...
pub(super) use source_scope::NATIVE_ACQUIRE_EXISTING_FIRST_TRUNCATE_ERROR_RELEASE_SUCCEEDED_PROJECTOR_DELTA_V1;
...
pub(super) const EXISTING_FIRST_TRUNCATE_ERROR_RELEASE_SUCCEEDED_MEMBER_COUNT: usize = 88;

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(super) enum LockExistingFirstTruncateErrorReleaseSucceededCompletionV1 {
    RetentionSucceeded,
    RetentionRouteUnknown,
}

impl LockExistingFirstTruncateErrorReleaseSucceededCompletionV1 {
...
#[derive(Clone, Copy)]
pub(super) struct LockNativeAcquireExistingFirstTruncateErrorReleaseSucceededProgramSpecV1 {
    #[cfg(windows)]
    ...
    pub(super) mask: u8,
    #[cfg(windows)]
    pub(super) completion: LockExistingFirstTruncateErrorReleaseSucceededCompletionV1,
...
) -> Option<LockExistingFirstTruncateErrorReleaseSucceededCompletionV1> {
    match value {
        ReachabilityV1::Reached(LockCompletionV1::UnsafeRetentionSucceededThenRouteUnknown) => {
            Some(LockExistingFirstTruncateErrorReleaseSucceededCompletionV1::RetentionSucceeded)
        }
        ReachabilityV1::Reached(LockCompletionV1::UnsafeRetentionRouteUnknownThenRouteUnknown) => {
            Some(LockExistingFirstTruncateErrorReleaseSucceededCompletionV1::RetentionRouteUnknown)
        }
        _ => None,
    }
}
...
fn expected_axes_v1(
    ...
    count: u8,
    mask: u8,
    completion: LockExistingFirstTruncateErrorReleaseSucceededCompletionV1,
) -> LockAxesV1 {
    LockAxesV1 {
