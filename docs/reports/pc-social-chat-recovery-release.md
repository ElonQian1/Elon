...
- 功能源码提交：`aec17a1ba7733cc76a75e37dc20726d06f4f54ba`，已推送 `origin/main`。最终前端发布提交：`c1e9e31dc7fe3a8779a8ed6f9c99ed6ce7580795`；两者前端输入完全一致，后者增加发布文档和注册表状态。
...
- 在线 `/pc/assets/release.json` 报告上述最终前端、后端 SHA；构建时间 `2026-09-15T07:31:02.4981125Z`。
