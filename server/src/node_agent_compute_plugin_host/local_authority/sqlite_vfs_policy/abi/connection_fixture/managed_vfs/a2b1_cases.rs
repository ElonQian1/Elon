...
fn a2b1_lock_execution_program_inventory_is_complete_but_non_authorizing() {
    ...
    assert_eq!(receipt.source_present_member_count, 3_034);
    assert_eq!(receipt.source_present_group_count, 3_034);
    assert_eq!(receipt.planned_missing_member_count, 5_634);
    assert_eq!(
        receipt
            .source_present_member_count
            .checked_add(receipt.planned_missing_member_count),
