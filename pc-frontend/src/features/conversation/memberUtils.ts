...
export const BUILTIN_ROLE_PERMISSIONS: Record<string, string[]> = {
  owner: [ROLE_PERMISSION_VIEW_MEMBERS, ROLE_PERMISSION_SEND_MESSAGES, ROLE_PERMISSION_MANAGE_PROJECT_SETTINGS],
  admin: [ROLE_PERMISSION_VIEW_MEMBERS, ROLE_PERMISSION_SEND_MESSAGES, ROLE_PERMISSION_MANAGE_PROJECT_SETTINGS],
