...
fn build_current_task_json(input: &TaskContextExportsInput<'_>) -> Option<String> {
    serde_json::to_string_pretty(&json!({
        ...
        "context_files": {
            ...
            "project_manifests": "project_manifests.json",
            "project_manifests_markdown": "project_manifests.md",
            "directory_summaries": "directory_summaries.json",
            "directory_summaries_markdown": "directory_summaries.md",
            "directories": "directories.jsonl",
            "repo_index": "repo_context_index.json",
            "repo_map": "repo_map.md",
            "symbols": "symbols.jsonl",
            "symbol_index": "symbol_index.jsonl",
            "symbol_edges": "symbol_edges.jsonl",
            "symbol_index_db": "symbol_index.sqlite",
            "edges": "edges.tsv",
            "chunks": "chunks.jsonl",
            "tests": "tests.jsonl",
