...
规则：`.github/copilot-instructions.md`。遵守 `WF-START` 至 `WF-REPORT`。
...
| PC `/pc`/React/Vite/TS | `.github/instructions/pc-frontend-migration.instructions.md`、`docs/pc-frontend-migration.md`、`AI_INDEX.md` |
...
| 聊天/下载溯源/慢任务 | `docs/query-chat-records.md` |
