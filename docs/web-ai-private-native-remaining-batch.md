...
| Personal sharing/list/revoke and deletion | Reuse [1644](reports/chatgpt-private-acceptance-1644.md), [Canvas 1673](reports/chatgpt-canvas-shared-links-20260911.md). [Source/update](reports/chatgpt-canvas-edit-publish-contract-20260912.md) and [native original editor](reports/chatgpt-original-canvas-save-20260912.md) await device | Editor acceptance, first-publication, disposable-link revoke, workspace/post/bulk and pagination remain |
