...
| 外部算力池适配器与统一报价 | V273源码/迁移21/21但production runtime未运行；V274/V277/V278 private源码均为`source_written/source_review_only/implementation_uncompiled/implementation_unrun`、0/0。#13-#18仍deny，Provider=`registering`、`eligible_rows=0`；sealed ingress无production validator/Runner caller。V280纵切架构、market-profile、planned 77列admission receipt及market projection identity三层ABI均已设计冻结，但初始inventory未选择、current profile authority不可构造，table/migration/source仍absent，整体unwired/uncompiled/unrun 0/0。见[`V280 vertical`](external-pool-service-managed-admission-runner-authority.md)、[`profile ABI`](external-pool-service-managed-market-profile-authority.md)、[`admission ABI`](external-pool-service-managed-admission-receipt-abi-authority.md)、[`projection ABI`](external-pool-service-managed-market-projection-identity-abi-authority.md)、[`V278`](external-pool-adapter-route-renewal-reachability-authority.md)与[`当前状态`](current-implementation-status.md) |
...
52. `docs/distributed-compute/external-pool-service-managed-market-projection-identity-abi-authority.md` 与对应 acceptance：冻结V280 Pool/ledger/Offer/publication/v171 snapshot的deterministic identity、single checked-at与legacy owner digest不改域；writer、migration与Gateway fence仍不存在。
