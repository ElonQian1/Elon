...
| Fresh independent text dispatch | ChatGPT | Completed/default-enabled for existing personal text on 1696 and new personal text on 1721; native first/follow-up and unarmed default verified | No uncertain-write replay. Tool/file/project/temporary and initial composer-free acceptance remain. [Baseline](chatgpt-fresh-text-dispatch.md), [new scope](reports/chatgpt-fresh-new-default-20260914.md) |
