...
use crate::{
    account_lifecycle, account_security, account_security_events, admin, admin_quota,
    admin_token_stats, agent_balloon, api, app_update, auth_api, billing_admin, billing_api,
    billing_pay, chat_attachments, codex_vault_api, context_compiler, conversation_forks,
    external_app_api, external_app_chat_bootstrap, external_app_mvp_chat, external_app_route_c_sdk,
    external_app_tool_report_api, federated_auth, friend_api, global_ws, group_ai,
...
mod admin_routes;
mod node_routes;
#[path = "quant_esk_allocation_receipt.rs"]
...
pub fn build_app(state: Arc<AppState>) -> Router {
    ...
    Router::new()
        ...
        .route(
            "/assets/orbital_mobile_theme.css",
            get(web::orbital_mobile_theme_css),
        )
        ...
        .route(
            ...
            get(web::ai_provider_accounts_js),
        )
        ...
        .merge(crate::compute_federation::federation_historical_lineage_read::routes())
        .merge(crate::compute_federation::capacity_instrument_api::routes())
        .merge(crate::compute_federation::capacity_commitment_api::routes())
        .merge(crate::compute_federation::delivery_allocation_api::routes())
        ...
        .merge(crate::compute_federation_settlement_account_api::routes())
        .merge(crate::compute_federation_settlement_release_batch_api::routes())
        ...
        .merge(crate::compute_federation_user_node_binding_api::routes())
