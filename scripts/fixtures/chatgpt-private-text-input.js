...
function fixture(f = base.fixture()) {
  ...
  Object.assign(f.page, { document, setTimeout, clearTimeout, location: { ...f.page.location, origin: 'https://chatgpt.com' },
    ...
    __elonChatGptPrivateTransport: f.page.__elonChatGptPrivateTransport ||
      { copySameOriginRequestHeaders: () => ({ Authorization: 'Bearer synthetic-fixture' }) } });
