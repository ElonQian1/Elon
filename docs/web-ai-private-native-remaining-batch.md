...
| Text submit/stream/stop/follow-up | Official runtime path verified, reused | Not independent Android HTTP POST. Native retry still returned unknown on 1637. Regeneration v7 adds a final tree check and closed failure reasons, passes 137 checks and is installed on 1638; unlock/device acceptance pending. [Current evidence](reports/chatgpt-regeneration-observation-1637.md). Other contexts remain separate |
