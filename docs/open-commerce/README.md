...
| 消费者 AI 与任意商户节点互联 | 商户主动发布的跨项目发现、授权和调用基础闭环已实现；生产身份、限流和滥用治理仍待完成 | `docs/open-commerce/consumer-developer-sandbox.md`、`docs/drafts/open-commerce-network-roadmap.md` |
