...
pub(super) fn digest_execution_program_inventory_source_scope_v1() -> Digest32 {
    ...
    add_u64(
        ...
        (SOURCE_SCOPE.len()
            ...
            + NATIVE_ACQUIRE_CREATED_FIRST_SHARED_BUSY_CLOSE_SUCCEEDED_PROJECTOR_DELTA_V1.len()
            + NATIVE_ACQUIRE_EXISTING_FIRST_SHARED_BUSY_CLOSE_SUCCEEDED_PROJECTOR_DELTA_V1.len())
            as u64,
    );
