...
| 外部算力池适配器与统一报价 | V273源码/迁移21/21但production runtime未运行；V274/V277/V278 private源码均为`source_written/source_review_only/implementation_uncompiled/implementation_unrun`、0/0。#13-#18仍deny，Provider=`registering`、`eligible_rows=0`。V280纵切及profile/admission/projection/Gateway-session-validator内部四层ABI已设计冻结；initial inventory和external semantic wire profile未选择，table/migration/source/validator/Runner仍absent，整体unwired/uncompiled/unrun 0/0。见[`V280 vertical`](external-pool-service-managed-admission-runner-authority.md)、[`profile`](external-pool-service-managed-market-profile-authority.md)、[`admission`](external-pool-service-managed-admission-receipt-abi-authority.md)、[`projection`](external-pool-service-managed-market-projection-identity-abi-authority.md)、[`Gateway/session`](external-pool-service-managed-gateway-session-validator-abi-authority.md)、[`V278`](external-pool-adapter-route-renewal-reachability-authority.md)与[`当前状态`](current-implementation-status.md) |
