...
$parsed=Split-ValidationCargoArguments -Arguments $args -ValueOptions @{'-CacheRoot'='CacheRoot';'-Domain'='Domain';'-TargetDir'='TargetDir';'-ReportRoot'='ReportRoot';'-CompileTimeoutSeconds'='CompileTimeoutSeconds';'-SharedBuildPartition'='SharedBuildPartition'} -SwitchOptions @('-DisableSccache','-SkipOfflineFirst')
