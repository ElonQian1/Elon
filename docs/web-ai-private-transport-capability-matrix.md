...
| Independent native file library | ChatGPT | Root/folder/cache/search and pagination data verified; module 8 estuary redirect fix released and 78 saved bytes verified in normal 1.1.1584; rendered UI and additional scopes pending; [evidence](chatgpt-private-library-browser.md) | Retained rows on refresh failure; explicit official library, no automatic navigation |
