use std::{error::Error as StdError, fmt, fs::File, sync::Arc};
...
impl ManagedParentNamespaceCustody {
    ...
    pub(super) fn validate_parent_identity(&self) -> std::io::Result<()> {
...
pub(crate) struct ManagedDeleteDisposition {
    pub(super) custody: ManagedParentNamespaceCustody,
}
...
impl ManagedParentRelativeAbsence {
    ...
    pub(super) fn into_disposition(self) -> ManagedDeleteDisposition {
