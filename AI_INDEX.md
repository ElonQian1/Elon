...
| 项目知识首页 / 产品功能图 / 技术架构图 / 主题树 / 独立治理属性 / 低 token MCP | `docs/README.md`、`.github/instructions/document-authority.instructions.md`、`docs/project-document-governance-mcp.md`、`pc-frontend/src/features/project-docs/`、`server/src/project_document_knowledge_graph*.rs`、`server/src/project_document_governance*.rs`、`server/src/node_agent_project_docs_mcp*.rs` |
