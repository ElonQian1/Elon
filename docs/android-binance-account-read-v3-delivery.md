...
- 39 项宿主 Debug 单测与 Debug/Release 编译通过；覆盖空列表身份、旧版字段、换号/换类型旧 grant 拒绝、撤销及过期。双包安装和实际只读导航另行记录，尚未取得本版本的设备证据。

正式主 APK 1.1.1661 (1661) 已经官方入口发布，源码 `a82bb3182aec5996b845acef73e0920ea50a6a20`，APK SHA-256 `ff190774c3d0d0663c804b48b21cf86a19a1981dcfa67f3f982d07a3348cf100`。远端版本、源码、文件大小和摘要与本地工件一致；本批关闭 ADB 自动部署，未安装或启动手机主应用。量化候选 0.7.21 (38) 的配套变更见量化仓库 PR 72，发布、装机与实际验收独立记录。
