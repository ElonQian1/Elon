...
| Fresh independent text dispatch | ChatGPT | Existing personal default completed on 1696; new personal first/follow-up passed on 1720. Narrow default promotion source-tested, release pending | No uncertain-write replay. Tool/file/project/temporary and initial composer-free acceptance remain. [Baseline](chatgpt-fresh-text-dispatch.md), [new scope](reports/chatgpt-fresh-new-default-20260914.md) |
