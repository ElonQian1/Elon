//! Exact q16 source programs for created-first DMS truncate failure with uncertain cleanup release.
//!
...
pub(super) use source_scope::NATIVE_ACQUIRE_CREATED_FIRST_TRUNCATE_ERROR_RELEASE_FAILED_PROJECTOR_DELTA_V1;
...
pub(super) const CREATED_FIRST_TRUNCATE_ERROR_RELEASE_FAILED_MEMBER_COUNT: usize = 88;

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(super) enum LockCreatedFirstTruncateErrorReleaseFailedCompletionV1 {
    RetentionSucceeded,
    RetentionRouteUnknown,
}

impl LockCreatedFirstTruncateErrorReleaseFailedCompletionV1 {
...
#[derive(Clone, Copy)]
pub(super) struct LockNativeAcquireCreatedFirstTruncateErrorReleaseFailedProgramSpecV1 {
    #[cfg(windows)]
    ...
    pub(super) mask: u8,
    #[cfg(windows)]
    pub(super) completion: LockCreatedFirstTruncateErrorReleaseFailedCompletionV1,
...
) -> Option<LockCreatedFirstTruncateErrorReleaseFailedCompletionV1> {
    match value {
        ReachabilityV1::Reached(LockCompletionV1::UnsafeRetentionSucceededThenRouteUnknown) => {
            Some(LockCreatedFirstTruncateErrorReleaseFailedCompletionV1::RetentionSucceeded)
        }
        ReachabilityV1::Reached(LockCompletionV1::UnsafeRetentionRouteUnknownThenRouteUnknown) => {
            Some(LockCreatedFirstTruncateErrorReleaseFailedCompletionV1::RetentionRouteUnknown)
        }
        _ => None,
    }
}
